(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("[STEP 1] 계좌신청 대상집계");
            obj.set_url("re::RTREAccReqProc_tab1.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab02);
            obj.set_text("[STEP 2] 계좌신청 대상조회");
            obj.set_url("re::RTREAccReqProc_tab2.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage3", this.Tab02);
            obj.set_text("[STEP 3] 파일 생성");
            obj.set_url("re::RTREAccReqProc_tab3.xfdl");
            this.Tab02.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "re::RTREAccReqProc_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTREAccReqProc_tab2.xfdl");
            this._addPreloadList("fdl", "re::RTREAccReqProc_tab3.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTREAccReqProc.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAccReqProc.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTREAccReqProc.xfdl");
