(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01", "absolute", "10", "9", "150", "21", null, null, this);
            obj.set_taborder("7");
            obj.set_text("재렌탈계약 상담목록");
            ...
            obj = new Static("st_contractInfo", "absolute", "10", "240", "144", "21", null, null, this);
            obj.set_taborder("42");
            obj.set_text("재렌탈 계약상담정보");
            obj.set_cssclass("sta_WF_subTitle");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDRerentalContractContactPopUp.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDRerentalContractContactPopUp.xfdl", function() {
        /***************************************************************************************************
         * 파 일 명 : RTSDRerentalContractContactPopUp.xfdl
         * 설    명 : (재렌탈)가계약상담(팝업)
         * 작 성 자 : kstka
         * 변경이력 :
         * 변경일자		변경자		변경내용
         * ----------	------		--------
         * 2018-08-20	kstka		최초생성
         ***************************************************************************************************/
        ...
        this.btn_close_onclick = function(obj,e) {
        	//20190722 kstka 재렌탈 상담시 부모창으로 넘겨주는 데이터
        	var arr ={
        		  p_recallDay : (nvl(this.ds_provsnContactList.getColumn(0, "recallDay")) == "")? "00000000":nvl(this.ds_provsnContactList.getColumn(0, "recallDay"))
        		, p_recallTm  : (nvl(this.ds_provsnContactList.getColumn(0, "recallTm")) == "")? "0000":nvl(this.ds_provsnContactList.getColumn(0, "recallTm"))
        		, p_callSeq : (nvl(this.ds_provsnContactList.getColumn(0, "callSeq")) == "")? "0":nvl(this.ds_provsnContactList.getColumn(0, "callSeq"))
        	};
        	
        	this.close(this.opener.returnPopup(arr));	
        }
        ...
        this.btn_sndSms_onclick = function(obj,e) {
        	...
        	var arr ={
        		  p_callId : "RTSDRerentalContractContactPopUp"
        		, p_phnNo  : vMobNo
        ...
        this.RTSDProvisionalContractContactPopUp_onclose = function(obj,e)
        {
        	//20190722 kstka 재렌탈 상담시 부모창으로 넘겨주는 데이터
        	var arr ={
        		  p_recallDay : (nvl(this.ds_provsnContactList.getColumn(0, "recallDay")) == "")? "00000000":nvl(this.ds_provsnContactList.getColumn(0, "recallDay"))
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onclose", this.RTSDProvisionalContractContactPopUp_onclose, this);
        ...
        this.loadIncludeScript("RTSDRerentalContractContactPopUp.xfdl");
