    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTCSAdviceStatus_tab_info3_etcPrdInfo");
                this.set_classname("RTSDContractStatus_tab_info5_preminumService");
                this.set_titletext("[STEP4]부가제품정보");
        ...
        // User Script
        this.addIncludeScript("RTCSAdviceStatus_tab_info3_etcPrdInfo.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCSAdviceStatus_tab_info3_etcPrdInfo.xfdl", function() {
        //include "lib::comLib.xjs";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.obj_data;
        this.BUTTON_CELL = 3;			//버튼CELL 위치
        ...
        this.loadIncludeScript("RTCSAdviceStatus_tab_info3_etcPrdInfo.xfdl");
