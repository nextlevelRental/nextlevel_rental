...
import egovframework.ntrms.kr.co.brn.cs.service.RTCSAnswerService;
import egovframework.rte.cmmn.ria.nexacro.NexacroConstant;
import egovframework.rte.cmmn.ria.nexacro.map.DataSetMap;
import egovframework.rte.cmmn.ria.nexacro.map.NexacroMapDTO;

@Controller
public class RTCSAnswerController {
	
	protected Log logger = LogFactory.getLog(this.getClass());	

	@Resource(name="rTCSAnswerService")
	RTCSAnswerService rTCSAnswerService;
	

	@RequestMapping("/ntrms/cs/answerList.do") 
	public ModelAndView answerList(NexacroMapDTO xpDto, Model model) throws Exception {
		...
		try
		{
			...
			List li = rTCSAnswerService.getAnswerList(inVar, outDataset);
	...
	@RequestMapping("/ntrms/cs/answerSaveDaset.do") 
	public ModelAndView answerSaveDaset(NexacroMapDTO xpDto, Model model, HttpServletRequest req) throws Exception {
		...
		try
		{
			...
			Map result = rTCSAnswerService.saveAnswerInfo(inDataset, inVar);
