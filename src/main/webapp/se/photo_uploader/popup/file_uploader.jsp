...
<%
String path    = request.getSession().getServletContext().getRealPath("/") + "attmp\\"; // 이미지가 저장될 주소
String urlPath = "/attmp/"; 
String filename = "";
...
<%
	...
	try {
		...
		if (!upfile.equals("")) {
			...
			String dateString = uuid.toString();
...
<script type="text/javascript">
	function fileAttach(){ 
		f = document.fileform;
		fpath = f.path.value;
	    fname = "<%=urlPath%>"+ f.filename.value; 
	    fcode = fpath + fname;
