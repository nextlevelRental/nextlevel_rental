    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREAgentCommission");
                this.set_classname("test");
                this.set_titletext("판매인별 수수료 내역집계");
        ...
        // User Script
        this.addIncludeScript("RTREAgentCommission.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAgentCommission.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 수수료 > 판매인별 수수료 내역집계
         * 02. 그룹명   : RTREAgentCommission.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_aggregate  = function() {
        		...
        		if(nvl(this.div_search.cal_referDate.value) == "") {
        			...
        			var sSvcID      	= "agentCommission";  
        			var sController   	= "/ntrms/re/agentCommission.do";
        			var sInDatasets   	= "";
        			var sOutDatasets  	= "";
        			var sArgs 			= "";	
        			var fn_callBack		= "fn_callBack";
        	...
        	{ 
        		...
        		{  
        		    case "getToday":
        		        ...
        		        this.div_search.cal_referDate.set_value(prevLastDate);			//전월 말일	
        		        break;
        ...
        this.loadIncludeScript("RTREAgentCommission.xfdl");
