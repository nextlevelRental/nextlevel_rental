...
########################################################
LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${PGM_LIB_DIR}/MagicCrypto/linux26.64
export LD_LIBRARY_PATH


########################################################
# NICE SecureConnector 실행
########################################################
cd ${PGM_BASE_DIR}/shbin
nohup ${JAVA_HOME}/bin/java -d64 -server -Dsvc=SecureConnector -Dlog4j.configuration=log4j.properties -Dbatch.prop=system.prop com.nice.secureconnector.SecureConnector &
