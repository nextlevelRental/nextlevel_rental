	...
	*/
	JsNamespace.declareClass("Eco.Point", {
		...
		"subtract": function(pt)
		{
			...
			{
				return new Eco.Point(this.x - arguments[0], this.y - arguments[1]);
			}
		},
		"multiply": function(pt)
		{
			...
			else
			{
				...
				{
					return new Eco.Point(this.x * arguments[0], this.y * arguments[0]);
				}
				else
				{
					return new Eco.Point(this.x * arguments[0], this.y * arguments[1]);
		...
		"divide": function(pt)
		{
			...
			if ( pt instanceof  Eco.Size )
			{
				return new Eco.Point(this.x / pt.width, this.y / pt.height);
			}
			return new Eco.Point(this.x / pt.x, this.y / pt.y);
		},
		"modulo": function(pt)
