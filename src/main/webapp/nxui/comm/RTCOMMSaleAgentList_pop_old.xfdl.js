(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("RTCOMMSaleAgentList_pop_old.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMSaleAgentList_pop_old.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMSaleAgentList_pop_old.xfdl");
