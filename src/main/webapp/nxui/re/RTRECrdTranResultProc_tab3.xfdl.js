    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECrdTranResultProc_tab3");
                this.set_classname("re00050_cms");
                this.set_titletext("[STEP3] 카드이체수납처리");
            ...
            obj = new Layout("default", "", 1122, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("[STEP3] 카드이체수납처리");
        ...
        // User Script
        this.addIncludeScript("RTRECrdTranResultProc_tab3.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECrdTranResultProc_tab3.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTRECrdTranResultProc_tab3.xfdl");
