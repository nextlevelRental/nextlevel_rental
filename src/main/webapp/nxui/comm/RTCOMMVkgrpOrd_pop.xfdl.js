    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTCOMMVkgrpOrd_pop");
                this.set_classname("RTCMVkgrp_pop");
                this.set_titletext("주문지사조회");
        ...
        // User Script
        this.addIncludeScript("RTCOMMVkgrpOrd_pop.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMVkgrpOrd_pop.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMVkgrpOrd_pop.xfdl");
