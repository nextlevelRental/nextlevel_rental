    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREAccTran");
                this.set_classname("re00050_cms");
                this.set_titletext("출금이체조회");
            ...
            obj.set_url("re::RTREAccTran_tab1.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab02);
            obj.set_text("은행별 내역조회");
            obj.set_url("re::RTREAccTran_tab2.xfdl");
            this.Tab02.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "re::RTREAccTran_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTREAccTran_tab2.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTREAccTran.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAccTran.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > CMS관리 > 출금이체조회
         * 02. 그룹명   : RTREAccTran.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTREAccTran.xfdl");
