    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREKCPDirectHisCheck");
                this.set_classname("RTREKCPPayHisCheck");
                this.set_titletext("KCP결제내역체크(즉시출금)");
            ...
            obj.set_url("re::RTREKCPDirectHisCheck_tab1.xfdl");
            this.Tab00.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab00);
            obj.set_text("[STEP 2] 차이 내역 조회");
            obj.set_url("re::RTREKCPDirectHisCheck_tab2.xfdl");
            this.Tab00.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1147, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("KCP결제내역체크(즉시출금)");
        ...
        {
            this._addPreloadList("fdl", "re::RTREKCPDirectHisCheck_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTREKCPDirectHisCheck_tab2.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTREKCPDirectHisCheck.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREKCPDirectHisCheck.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        //include "lib::comLib.xjs";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.p_arg = "RTREKCPDirectHisCheck";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.fn_callBack = function (strSvcId,nErrorCode,strErrorMsg){
        	
        }
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.RTREKCPDirectHisCheck_onload = function(obj,e){
        	Ex.core.init(obj);
        }
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        {
            this.addEventHandler("onload", this.RTREKCPDirectHisCheck_onload, this);
            this.Tab00.addEventHandler("onchanged", this.Tab00_onchanged, this);

        };

        this.loadIncludeScript("RTREKCPDirectHisCheck.xfdl");
