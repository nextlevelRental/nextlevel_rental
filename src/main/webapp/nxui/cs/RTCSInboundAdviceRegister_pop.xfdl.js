    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,1147,640);
            }
            ...
            obj = new Div("div_search", "absolute", "8", "0", "1122", "45", null, null, this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            obj.set_scrollbars("none");
            obj.set_cssclass("div_WF_searchBg");
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "8", "18", "100", "21", null, null, this.div_search);
            obj.set_taborder("1");
            obj.set_text("상담전화번호");
            obj.set_cssclass("sta_WF_schTitle");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "265", "18", "100", "21", null, null, this.div_search);
            obj.set_taborder("4");
            obj.set_text("고객명");
            obj.set_cssclass("sta_WF_schTitle");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static22", "absolute", "0", "8", null, "12", "0", null, this.div_search);
            obj.set_taborder("7");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "0", "38", null, "12", "0", null, this.div_search);
            obj.set_taborder("8");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("ed_custNm", "absolute", "369", "18", "118", "21", null, null, this.div_search);
            obj.set_taborder("2");
            obj.set_password("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("ed_custNo", "absolute", "506", "18", "118", "21", null, null, this.div_search);
            obj.set_taborder("9");
            obj.set_enable("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_custNmSearch", "absolute", "485", "17", "21", "21", null, null, this.div_search);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_edtSch");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "658", "18", "79", "21", null, null, this.div_search);
            obj.set_taborder("11");
            obj.set_text("일자");
            obj.set_cssclass("sta_WF_schTitle");
            this.div_search.addChild(obj.name, obj);
            obj = new Calendar("cal_startDay", "absolute", "726", "18", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("12");
            obj.set_dateformat("yyyy-MM-dd");
            obj = new Static("Static07", "absolute", "829", "18", "9", "21", null, null, this.div_search);
            obj.set_taborder("13");
            obj.set_text("~");
            this.div_search.addChild(obj.name, obj);
            obj = new Calendar("cal_endDay", "absolute", "841", "18", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("14");
            obj.set_dateformat("yyyy-MM-dd");
            obj = new Edit("ed_telNo", "absolute", "111", "18", "121", "21", null, null, this.div_search);
            obj.set_taborder("16");
            obj.set_maxlength("15");
            this.div_search.addChild(obj.name, obj);

            obj = new Grid("grid_ordList", "absolute", "8", "86", "1122", "200", null, null, this);
            obj.set_taborder("17");
            ...
            obj = new Static("Static00", "absolute", "8", "45", "1147", "20", null, null, this);
            obj.set_taborder("15");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "8", "61", "169", "20", null, null, this);
            obj.set_taborder("16");
            obj.set_text("계약 리스트");
            obj.set_cssclass("sta_WF_subTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "8", "76", "1147", "10", null, null, this);
            obj.set_taborder("18");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static01", "absolute", "1130", "0", "25", "1040", null, null, this);
            obj.set_taborder("25");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "8", "302", "169", "20", null, null, this);
            obj.set_taborder("26");
            obj.set_text("아웃바운드 상담리스트");
            obj.set_cssclass("sta_WF_subTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "8", "317", "1147", "10", null, null, this);
            obj.set_taborder("27");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "8", "286", "1147", "20", null, null, this);
            obj.set_taborder("28");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Grid("grid_rtcs0102Out", "absolute", "8", "327", "800", "200", null, null, this);
            obj.set_taborder("19");
            ...
            obj = new Static("Static07", "absolute", "8", "527", "1147", "20", null, null, this);
            obj.set_taborder("29");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "8", "543", "169", "20", null, null, this);
            obj.set_taborder("30");
            obj.set_text("인바운드 상담리스트");
            obj.set_cssclass("sta_WF_subTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "8", "558", "1147", "10", null, null, this);
            obj.set_taborder("31");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Grid("grid_rtcs0102In", "absolute", "8", "568", "800", "200", null, null, this);
            obj.set_taborder("21");
            ...
            obj = new Static("Static10", "absolute", "8", "812", "1122", "31", null, null, this);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "8", "842", "1122", "31", null, null, this);
            obj.set_taborder("33");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);

            obj = new Static("Static12", "absolute", "8", "920", "1122", "100", null, null, this);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);

            obj = new Static("Static35", "absolute", "8", "812", "80", "31", null, null, this);
            obj.set_taborder("35");
            obj.set_text("상담일자");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Static("Static13", "absolute", "197", "812", "80", "31", null, null, this);
            obj.set_taborder("36");
            obj.set_text("상담시간");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", "499", "812", "100", "31", null, null, this);
            obj.set_taborder("37");
            obj.set_text("상담전화번호");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_carNo", "absolute", "833", "817", "112", "21", null, null, this);
            obj.set_taborder("6");
            obj.set_maxlength("10");
            this.addChild(obj.name, obj);

            obj = new Static("Static15", "absolute", "740", "812", "90", "31", null, null, this);
            obj.set_taborder("38");
            obj.set_text("차량번호");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Static("Static17", "absolute", "598", "842", "80", "31", null, null, this);
            obj.set_taborder("39");
            obj.set_text("고객번호");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_custNo", "absolute", "683", "847", "141", "21", null, null, this);
            obj.set_taborder("11");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static18", "absolute", "8", "842", "80", "31", null, null, this);
            obj.set_taborder("40");
            obj.set_text("상담유형");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Static("Static20", "absolute", "197", "842", "80", "31", null, null, this);
            obj.set_taborder("41");
            obj.set_text("지역");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Combo("cb_region", "absolute", "284", "847", "120", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("9");
            ...
            obj = new Combo("cb_city", "absolute", "410", "847", "120", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("10");
            obj.set_autoselect("true");
            obj.set_displayrowcount("5");
            ...
            obj = new Combo("cb_recvTp", "absolute", "92", "847", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("8");
            obj.set_autoselect("true");
            obj.set_displayrowcount("5");
            ...
            obj = new TextArea("TextArea00", "absolute", "833", "327", "297", "200", null, null, this);
            obj.set_taborder("20");
            ...
            obj = new TextArea("TextArea01", "absolute", "833", "568", "297", "200", null, null, this);
            obj.set_taborder("22");
            obj.set_readonly("true");
            obj.set_linespace("3");
            obj.set_visible("true");
            ...
            obj = new TextArea("ed_callDtl", "absolute", "92", "926", "1033", "89", null, null, this);
            obj.set_taborder("14");
            ...
            obj = new Static("Static21", "absolute", "8", "920", "80", "100", null, null, this);
            obj.set_taborder("42");
            obj.set_text("상담내용");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Static("Static22", "absolute", "8", "768", "1147", "20", null, null, this);
            obj.set_taborder("43");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static23", "absolute", "808", "286", "25", "502", null, null, this);
            obj.set_taborder("44");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "8", "1020", "1147", "20", null, null, this);
            obj.set_taborder("45");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_recvDay", "absolute", "93", "818", "100", "20", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_enable("false");

            obj = new Static("Static25", "absolute", "334", "817", "15", "21", null, null, this);
            obj.set_taborder("46");
            obj.set_text("시");
            this.addChild(obj.name, obj);

            obj = new Static("Static26", "absolute", "412", "817", "15", "21", null, null, this);
            obj.set_taborder("47");
            obj.set_text("분");
            this.addChild(obj.name, obj);

            obj = new Static("Static27", "absolute", "482", "817", "15", "21", null, null, this);
            obj.set_taborder("48");
            obj.set_text("초");
            this.addChild(obj.name, obj);

            obj = new Static("Static29", "absolute", "8", "872", "1122", "50", null, null, this);
            obj.set_taborder("49");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);

            obj = new Static("Static28", "absolute", "8", "872", "80", "50", null, null, this);
            obj.set_taborder("50");
            obj.set_text("SMS내용");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new TextArea("ed_smsTx", "absolute", "92", "877", "1033", "40", null, null, this);
            obj.set_taborder("13");
            obj.set_linespace("3");
            obj.style.set_linespace("3");
            obj.style.set_background("#ffffffff");
            ...
            obj = new Button("btn_new", "absolute", "965", "788", "80", "21", null, null, this);
            obj.set_taborder("23");
            obj.set_text("신규");
            obj.getSetter("domainId").set("nexa.save");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save", "absolute", "1050", "788", "80", "21", null, null, this);
            obj.set_taborder("24");
            obj.set_text("저장");
            obj.getSetter("domainId").set("nexa.save");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_hh", "absolute", "283", "818", "45", "21", null, null, this);
            obj.set_taborder("2");
            ...
            obj = new Edit("ed_mi", "absolute", "359", "818", "45", "21", null, null, this);
            obj.set_taborder("3");
            obj.set_inputtype("number");
            obj.set_maxlength("2");
            obj.set_enable("false");
            ...
            obj = new Edit("ed_ss", "absolute", "433", "818", "45", "21", null, null, this);
            obj.set_taborder("4");
            obj.set_inputtype("number");
            obj.set_maxlength("2");
            obj.set_enable("false");
            ...
            obj = new Static("Static19", "absolute", "949", "812", "70", "31", null, null, this);
            obj.set_taborder("51");
            obj.set_text("고객명");
            obj.set_cssclass("sta_WF_detailLabelP");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_custNm", "absolute", "1023", "817", "100", "21", null, null, this);
            obj.set_taborder("7");
            obj.set_maxlength("50");
            obj.set_lengthunit("ascii");
            this.addChild(obj.name, obj);

            obj = new Static("Static16", "absolute", "829", "842", "90", "31", null, null, this);
            obj.set_taborder("52");
            obj.set_text("계약번호");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_ordNo", "absolute", "923", "847", "201", "21", null, null, this);
            obj.set_taborder("12");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_telNo", "absolute", "603", "817", "133", "21", null, null, this);
            obj.set_taborder("5");
            obj.set_maxlength("15");
            this.addChild(obj.name, obj);

            obj = new Button("Button00", "absolute", "1085", "59", "45", "22", null, null, this);
            obj.set_taborder("53");
            obj.set_text("엑셀");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("Button01", "absolute", "1085", "300", "45", "22", null, null, this);
            obj.set_taborder("54");
            obj.set_text("엑셀");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("Button02", "absolute", "1085", "541", "45", "22", null, null, this);
            obj.set_taborder("55");
            obj.set_text("엑셀");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("Button03", "absolute", "1068", "18", "45", "22", null, null, this);
            obj.set_taborder("56");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 1147, 640, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("RTCSInboundAdviceRegister_pop.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCSInboundAdviceRegister_pop.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("RTCSInboundAdviceRegister_pop.xfdl");
