    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREServiceCharge");
                this.set_classname("test");
                this.set_titletext("서비스수수료 기초집계");
            ...
            obj = new Static("Static06", "absolute", "0", "55", "100", "21", null, null, this);
            obj.set_taborder("9");
            obj.set_text("작업상태");
        ...
        // User Script
        this.addIncludeScript("RTREServiceCharge.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREServiceCharge.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 수수료 > 서비스수수료 기초집계
         * 02. 그룹명   : RTREServiceCharge.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   : 2015.11.26
         * 05. 작성자   : 
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_aggregate  = function() {
        		...
        		if(nvl(this.div_search.cal_referDate.value) == "") {
        			...
        			var sSvcID      	= "serviceChargeAggregate";  
        			var sController   	= "/ntrms/re/serviceChargeAggregate.do";
        			var sInDatasets   	= "";
        			var sOutDatasets  	= "";
        			var sArgs 			= "";	
        			var fn_callBack		= "fn_callBack";
        	...
        	***********************************************************************************/
        	...
        	{ 
        		...
        		if (nErrorCode < 0) 
        		{
        			if(strSvcId == "serviceChargeAggregate") {
        ...
        this.loadIncludeScript("RTREServiceCharge.xfdl");
