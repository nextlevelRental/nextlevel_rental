(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("1");
            obj.set_text("본문 내용 추기하기");
            this.addChild(obj.name, obj);

            obj = new Button("Button00", "absolute", "24.13%", "8", null, "39", "59.05%", null, this);
            obj.set_taborder("2");
            obj.set_text("본문 내용 가져오기");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("sample006.xfdl", function() {
        /***********************************************************************************
        * SYSTEM      : sample006
        * BUSINESS    : Eco웹에디터샘플
        * FILE NAME   : sample006
        ...
        ***********************************************************************************/
        ...
        // 			],
        			...
        			contentHeight: 514,	// minHeight 100, maxHeight : Div00 height 가 form height 초과시 onresizeEditor에서 로직 추가로 처리
        			//contentWidth: ,
        			style: {
        				color: "#000000",
        				fontFamily: "Verdana",
        ...
        this.loadIncludeScript("sample006.xfdl");
