    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREBondAggregate");
                this.set_classname("re00050_cms");
                this.set_titletext("채권대상 집계");
            ...
            obj.set_text("[STEP 1] 연체대상 집계");
            obj.set_url("re::RTREBondAggregate_tab1.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab02);
            obj.set_text("[STEP 2] 채권관리대상 집계");
            obj.set_url("re::RTREBondAggregate_tab2.xfdl");
            this.Tab02.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "re::RTREBondAggregate_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTREBondAggregate_tab2.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTREBondAggregate.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREBondAggregate.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 채권관리 > 채권대상집계
         * 02. 그룹명   : RTREBondAggregate.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTREBondAggregate.xfdl");
