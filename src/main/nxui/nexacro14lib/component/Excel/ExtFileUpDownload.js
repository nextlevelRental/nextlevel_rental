	  ...
	  _pExtFileUpload.on_fire_onloadstart = function (obj, type, evt, fileId)
	  {
		...
		_pExtFileUpload._makeLoadHandler = function (pThis, pFileId, pLoadItem) {
			...
			return function(evt) {
				...
				//trace("\n\n >>>>> _bindLoadHandler:" + pThis + ",pLoadItem:" + pLoadItem + ",evt:" + evt.type + ",itemType:" + itemType + ",responseType:" + this.responseType);
		...
		{
			//trace("\n\n★★on_loadframe_filemodule type:" + type + ",code:" + code + ",msg:" + msg + ",url:" + url);
