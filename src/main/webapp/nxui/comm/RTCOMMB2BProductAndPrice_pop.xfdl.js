(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cellsizingtype("col");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"100\"/><Column size=\"248\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"42\"/><Column size=\"85\"/><Column size=\"0\"/><Column size=\"95\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"상품코드\"/><Cell col=\"2\" text=\"상품명\"/><Cell col=\"3\" text=\"가격적용 시작일\"/><Cell col=\"4\" text=\"가격적용 완료일\"/><Cell col=\"5\" text=\"본수\"/><Cell col=\"6\" text=\"렌탈기간\"/><Cell col=\"7\" text=\"렌탈등록비\"/><Cell col=\"8\" text=\"렌탈료\"/></Band><Band id=\"body\"><Cell text=\"bind:seq\"/><Cell col=\"1\" text=\"bind:matCd\"/><Cell col=\"2\" text=\"bind:matNm\"/><Cell col=\"3\" displaytype=\"date\" text=\"bind:strDay\" calendardisplaynulltype=\"none\"/><Cell col=\"4\" displaytype=\"date\" text=\"bind:endDay\" calendardisplaynulltype=\"none\"/><Cell col=\"5\" displaytype=\"combo\" text=\"bind:cntCd\" combodataset=\"ds_cnt\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"6\" displaytype=\"combo\" text=\"bind:periodCd\" combodataset=\"ds_period\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"7\" text=\"bind:regiAmt\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;\" text=\"bind:rentAmt\" mask=\"###,###,###,##0\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTCOMMB2BProductAndPrice_pop.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMB2BProductAndPrice_pop.xfdl", function() {
        ...
        this.loadIncludeScript("RTCOMMB2BProductAndPrice_pop.xfdl");
