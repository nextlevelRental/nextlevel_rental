    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECrdTran_tab2");
                this.set_classname("re00050_cms");
                this.set_titletext("카드사별 내역조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"rcrdDay\" type=\"STRING\" size=\"256\"/><Column id=\"cardcomCd\" type=\"STRING\" size=\"256\"/><Column id=\"cardcomNm\" type=\"STRING\" size=\"256\"/><Column id=\"reqstCnt\" type=\"STRING\" size=\"256\"/><Column id=\"reqstAmt\" type=\"STRING\" size=\"256\"/><Column id=\"srecpCnt\" type=\"STRING\" size=\"256\"/><Column id=\"srecpAmt\" type=\"STRING\" size=\"256\"/><Column id=\"hsrcpCnt\" type=\"STRING\" size=\"256\"/><Column id=\"hsrcpAmt\" type=\"STRING\" size=\"256\"/><Column id=\"trecpAmt\" type=\"STRING\" size=\"256\"/><Column id=\"erecpCnt\" type=\"STRING\" size=\"256\"/><Column id=\"feeAmt\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Static("Static02", "absolute", "10", "91", "1103", "10", null, null, this);
            obj.set_taborder("8");
        ...
        // User Script
        this.addIncludeScript("RTRECrdTran_tab2.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECrdTran_tab2.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > CMS관리 > 카드이체조회 > 카드사별 내역조회
         * 02. 그룹명   : RTRECrdTran_tab2.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_search = function()
        	{
        		if(this.fn_getValidRcmsDay()) {	
        			var sSvcID      	= "getCrdTranCardList";  
        			var sController   	= "ntrms/re/getCrdTranCardList.do";
        			var sInDatasets   	= "";
        ...
        this.loadIncludeScript("RTRECrdTran_tab2.xfdl");
