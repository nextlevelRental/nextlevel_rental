    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,503,321);
            }
            ...
            obj = new Static("st_bg", "absolute", "10", "45", "480", "267", null, null, this);
            obj.set_taborder("2");
            ...
            obj = new Grid("grd_files", "absolute", "20", "94", "460", "202", null, null, this);
            obj.set_taborder("20");
            ...
            obj = new Static("st_helpMessage", "absolute", "22", "96", "455", "198", null, null, this);
            obj.set_taborder("32");
            ...
            obj = new Static("st_title00", "absolute", "10", "5", "118", "38", null, null, this);
            obj.set_taborder("19");
            obj.set_text("파일업로드");
            obj.style.set_font("bold antialias 12 Verdana");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("img_loading", "absolute", "103", "174", "280", "60", null, null, this);
            obj.set_taborder("22");
            obj.set_visible("false");
            obj.style.set_background("transparent URL('image::fileUpDownload/loading.gif')");
            ...
            obj = new Button("btn_selectFiles", "absolute", "123", "58", "94", "30", null, null, this);
            obj.set_taborder("26");
            obj.set_text("파일추가");
            obj.style.set_background("#8a4296ff URL('image::fileUpDownload/file_btn_AddFiles.png') 12 48");
            ...
            obj = new Button("btn_clearAll", "absolute", "220", "58", "94", "30", null, null, this);
            obj.set_taborder("27");
            obj.set_text("파일삭제");
            ...
            obj = new Button("btn_save", "absolute", "317", "58", "83", "30", null, null, this);
            obj.set_taborder("28");
            obj.set_text("업로드");
            ...
            obj = new Button("btn_save00", "absolute", "80.12%", "58", null, "30", "4.97%", null, this);
            obj.set_taborder("33");
            obj.set_text("저장");
            obj.style.set_background("#5d5d5dff URL('image::fileUpDownload/file_btn_Save.png') 15 48");
            obj.style.set_color("white");
            ...
            obj = new Static("Static00", "absolute", "165", "24", "336", "21", null, null, this);
            obj.set_taborder("34");
            obj.set_text("파일추가후 1. 업로드, 2. 저장버튼을 눌러 저장처리하십시오");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 503, 321, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("FileUpDownload.xfdl", "lib::comLib.xjs");
        this.registerScript("FileUpDownload.xfdl", function() {
        ...
        this.uploadFiles = function()
        {
        	...
        	if (addFileLen > 0)
        	{
        		...
        		*/
        		...
        		//[전체전송]
        		extUp.upload(url, "ds_input=ds_files", "ds_output=ds_output", this.transferType, 0);
        ...
        */
        ...
        this.saveUploadImage = function(obj,e){
        		var arr = [this.ds_output];	
        		//this.gfn_popupClose(arr);
        		this.close(this.opener.resultUploadFile(arr));
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_save00.addEventHandler("onclick", this.saveUploadImage, this);

        };

        this.loadIncludeScript("FileUpDownload.xfdl");
