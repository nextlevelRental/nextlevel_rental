    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREInstallCommission");
                this.set_classname("test");
                this.set_titletext("장착수수료 기초집계");
            ...
            obj = new Edit("edt_procStatus", "absolute", "134", "86", "982", "21", null, null, this);
            obj.set_taborder("8");
        ...
        // User Script
        this.addIncludeScript("RTREInstallCommission.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREInstallCommission.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTREInstallCommission.xfdl");
