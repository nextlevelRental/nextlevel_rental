    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTCSOutboundListDivideP");
                this.set_classname("RTCSHappyCallRegister");
                this.set_titletext("아웃바운드배정(가계약)");
            ...
            obj = new Calendar("cal_order_to", "absolute", "219", "10", "100", "21", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("34");
            ...
            obj.set_text("~");
            this.Div00.addChild(obj.name, obj);
            obj = new Calendar("cal_order_from", "absolute", "105", "10", "100", "21", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("36");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_value("null");
            ...
            obj.set_visible("false");
            this.Div00.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "342", "10", "80", "21", null, null, this.Div00);
            obj.set_taborder("44");
            obj.set_text("상담유형");
            obj.set_cssclass("sta_WF_schTitle");
            this.Div00.addChild(obj.name, obj);
            obj = new Combo("cmb_provsnTp", "absolute", "36.94%", "12", null, "20", "49.64%", null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("45");
            obj.set_innerdataset("@dsS317");
        ...
        // User Script
        this.addIncludeScript("RTCSOutboundListDivideP.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCSOutboundListDivideP.xfdl", function() {
        /***********************************************************************
         * Script Include 
         ************************************************************************/
        ...
        ***********************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.cal_order_to.addEventHandler("onchanged", this.Div00_Calendar02_onchanged, this);
            this.Div00.cal_order_to.addEventHandler("canchange", this.Div00_Calendar02_canchange, this);
        ...
        this.loadIncludeScript("RTCSOutboundListDivideP.xfdl");
