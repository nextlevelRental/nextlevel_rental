    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECmsTranResult_tab1");
            ...
            obj = new Static("Static08", "absolute", "10", "101", "130", "31", null, null, this);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_fileSvrLoc", "absolute", "144", "136", "500", "21", null, null, this);
            obj.set_taborder("18");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "10", "131", "130", "31", null, null, this);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_locPos", "absolute", "18", "108", "120", "20", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdo_svrPos", "absolute", "18", "137", "120", "20", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new FileUpload("FileUpload00", "absolute", "144", "105", "500", "25", null, null, this);
            obj.set_taborder("26");
            ...
            obj = new Static("sta_fileDesc", "absolute", "649", "107", "455", "20", null, null, this);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_text");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_fileNm", "absolute", "145", "106", "427", "21", null, null, this);
            obj.set_taborder("28");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTRECmsTranResult_tab1.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECmsTranResult_tab1.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTRECmsTranResult_tab1.xfdl");
