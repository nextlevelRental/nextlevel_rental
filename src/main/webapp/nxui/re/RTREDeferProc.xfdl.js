    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREDeferProc");
                this.set_classname("test_form");
                this.set_titletext("렌탈등록비 이연처리");
        ...
        // User Script
        this.addIncludeScript("RTREDeferProc.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREDeferProc.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 마감관리 > 렌탈등록비 이연처리
         * 02. 그룹명   : RTREDeferProc.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_aggregate  = function() {
        		...
        		var sSvcID      	= "deferProcAggregate";  
        		var sController   	= "ntrms/re/deferProcAggregate.do";
        		var sInDatasets   	= "";
        		var sOutDatasets  	= "";
        		var sArgs 			= "";	
        		var fn_callBack		= "fn_callBack";
        	...
        	***********************************************************************************/
        	...
        	{ 
        		if (nErrorCode < 0) 
        		{
        			if(strSvcId == "deferProcAggregate") {
        ...
        this.loadIncludeScript("RTREDeferProc.xfdl");
