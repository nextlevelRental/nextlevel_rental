(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("RTCOMMVkbur_pop_old.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMVkbur_pop_old.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMVkbur_pop_old.xfdl");
