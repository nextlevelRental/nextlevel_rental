    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTCOMMOrderNo_pop");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"ordDay\" type=\"STRING\" size=\"256\"/><Column id=\"ordNo\" type=\"STRING\" size=\"256\"/><Column id=\"custNo\" type=\"STRING\" size=\"256\"/><Column id=\"birthDay\" type=\"STRING\" size=\"256\"/><Column id=\"buslNo\" type=\"STRING\" size=\"256\"/><Column id=\"custNm\" type=\"STRING\" size=\"256\"/><Column id=\"genderCd\" type=\"STRING\" size=\"256\"/><Column id=\"genderNm\" type=\"STRING\" size=\"256\"/><Column id=\"lfCd\" type=\"STRING\" size=\"256\"/><Column id=\"lfNm\" type=\"STRING\" size=\"256\"/><Column id=\"mobNo\" type=\"STRING\" size=\"256\"/><Column id=\"telNo\" type=\"STRING\" size=\"256\"/><Column id=\"telNo2\" type=\"STRING\" size=\"256\"/><Column id=\"addr\" type=\"STRING\" size=\"256\"/><Column id=\"carNo\" type=\"STRING\" size=\"256\"/><Column id=\"makerCd\" type=\"STRING\" size=\"256\"/><Column id=\"modelCd\" type=\"STRING\" size=\"256\"/><Column id=\"contentsCd\" type=\"STRING\" size=\"256\"/><Column id=\"frCd\" type=\"STRING\" size=\"256\"/><Column id=\"carKind\" type=\"STRING\" size=\"256\"/><Column id=\"statCd\" type=\"STRING\" size=\"256\"/><Column id=\"statNm\" type=\"STRING\" size=\"256\"/><Column id=\"matCd\" type=\"STRING\" size=\"256\"/><Column id=\"matNm\" type=\"STRING\" size=\"256\"/><Column id=\"planDay\" type=\"STRING\" size=\"256\"/><Column id=\"instDay\" type=\"STRING\" size=\"256\"/><Column id=\"mfpYn\" type=\"STRING\" size=\"256\"/><Column id=\"bondSelDay\" type=\"STRING\" size=\"256\"/><Column id=\"chanCd\" type=\"STRING\" size=\"256\"/><Column id=\"o2oYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"40\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"0\"/><Column size=\"100\"/><Column size=\"0\"/><Column size=\"100\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"65\"/><Column size=\"55\"/><Column size=\"60\"/><Column size=\"84\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"계약일자\"/><Cell col=\"1\" text=\"계약번호\"/><Cell col=\"2\" text=\"계약상태\"/><Cell col=\"3\" text=\"상태상세\"/><Cell col=\"4\" text=\"연체금액\"/><Cell col=\"5\" text=\"완납/해지/채권\"/><Cell col=\"6\" text=\"고객코드\"/><Cell col=\"7\" text=\"법정생년월일\"/><Cell col=\"8\" text=\"사업자번호\"/><Cell col=\"9\" text=\"고객명\"/><Cell col=\"10\" text=\"성별\"/><Cell col=\"11\" text=\"내외국인\"/><Cell col=\"12\" text=\"핸드폰\"/><Cell col=\"13\" text=\"핸드폰\"/><Cell col=\"14\" text=\"전화번호\"/><Cell col=\"15\" text=\"전화번호\"/><Cell col=\"16\" text=\"전화번호2\"/><Cell col=\"17\" text=\"전화번호2\"/><Cell col=\"18\" text=\"주소\"/><Cell col=\"19\" text=\"차량번호\"/><Cell col=\"20\" text=\"차종\"/><Cell col=\"21\" text=\"채널\"/><Cell col=\"22\" text=\"홈쇼핑\"/><Cell col=\"23\" text=\"월렌탈료\"/><Cell col=\"24\" text=\"단체번호\"/></Band><Band id=\"body\"><Cell displaytype=\"date\" text=\"bind:ordDay\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"readonly\" text=\"bind:ordNo\"/><Cell col=\"2\" text=\"bind:statNm\"/><Cell col=\"3\" text=\"expr:(overDueAmt == '-') || (overDueAmt == '0') ? statNmDetail : statNmDetail + '/연체'\"/><Cell col=\"4\" displaytype=\"number\" text=\"bind:overDueAmt\"/><Cell col=\"5\" text=\"bind:mfpYn\"/><Cell col=\"6\" text=\"bind:custNo\"/><Cell col=\"7\" displaytype=\"normal\" text=\"bind:birthDay\" mask=\"####-##-##\"/><Cell col=\"8\" displaytype=\"normal\" text=\"bind:buslNo\" mask=\"###-##-#####\"/><Cell col=\"9\" text=\"bind:custNm\"/><Cell col=\"10\" text=\"bind:genderNm\"/><Cell col=\"11\" text=\"bind:lfNm\"/><Cell col=\"12\" text=\"bind:mobNo\" expr=\"expr:FN_numberMaskReturn(mobNo)\"/><Cell col=\"13\" text=\"bind:mobNo\"/><Cell col=\"14\" text=\"bind:telNo\" expr=\"expr:FN_numberMaskReturn(telNo)\"/><Cell col=\"15\" text=\"bind:telNo\" expr=\"expr:FN_numberHyphenInReturn(telNo)\"/><Cell col=\"16\" text=\"bind:telNo2\" expr=\"expr:FN_numberMaskReturn(telNo2)\"/><Cell col=\"17\" text=\"bind:telNo2\" expr=\"expr:FN_numberHyphenInReturn(telNo2)\"/><Cell col=\"18\" text=\"bind:addr\"/><Cell col=\"19\" text=\"bind:carNo\"/><Cell col=\"20\" text=\"bind:carKind\"/><Cell col=\"21\" text=\"bind:chanNm\"/><Cell col=\"22\" text=\"bind:hshopGbNm\"/><Cell col=\"23\" displaytype=\"number\" text=\"bind:monAmt\"/><Cell col=\"24\" text=\"bind:grpNo\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTCOMMOrderNo_pop.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMOrderNo_pop.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.fn_callBack = function (strSvcId,nErrorCode,strErrorMsg,resultCnt,checkAuthGrpuCd){
        	...
        	if( strSvcId == "ordNoList" ){
        		...
        		//[20230210_1] kstka
        		//=====================================================================================
        		if(nvl(this.parent.p_crList) == 'Y'){
        			this.ds_ordNoList.filter("chanCd != '02' && o2oYn == 'N'");
        		}
        		//=====================================================================================
        ...
        this.FN_search = function(sArgs){
        	...
        	/*|||주문등록 계약번호 조회 필터|||*/
        	if(nvl(this.parent.p_crList) == 'Y'){
        		 sArgs += Ex.util.setParam("groNoYn", 'D');
        		 sArgs += Ex.util.setParam("ordId", '01');
        	}
        ...
        this.FN_choice = function(){
        	...
        	if( pos == -1 ){
        		...
        		if(this.parent.p_arg == "RTSDPlan"){ //장착등록 RTSDPlan.xfdl
        		...
        		}else if(this.parent.p_arg == "RTSDOrder") { //주문현황리스트 RTSDOrder.xfdl
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNoInfo(ordNo));
        		}else if(this.parent.p_arg == "RTSDClaim") {
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNoInfo(ordNo));
        		}else if(this.parent.p_arg == "RTSDContractRegister") {
        			var ordNo 	 = this.ds_ordNoList.getColumn(pos, "ordNo");
        			var birthDay = this.ds_ordNoList.getColumn(pos, "birthDay");
        			var telNo  	 = this.ds_ordNoList.getColumn(pos, "telNo");
        			...
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNoInfo(ordNo));
        		}else if(this.parent.p_arg == "RTREDeferSelect"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNoInfo(ordNo));
        		}else if(this.parent.p_arg == "RTCSRegularCheck"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNoInfo(ordNo));
        			...
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));
        		}else if(this.parent.p_arg == "RTCOMMStrgRegister"){
        			var ordNo		= nvl(this.ds_ordNoList.getColumn(pos, "ordNo"));
        			var carKind		= nvl(this.ds_ordNoList.getColumn(pos, "carKind"));
        			var telNo		= nvl(this.ds_ordNoList.getColumn(pos, "telNo"));
        			...
        			var seasonCd	= nvl(this.ds_ordNoList.getColumn(pos, "seasonCd"));
        			var statCd 	 	= nvl(this.ds_ordNoList.getColumn(pos, "statCd"));
        			...
        			if( (statCd != "03") && (statCd != "04") ){
        				...
        				var arr = [ ordNo, carKind, telNo, custNo, custNm, carNo, mobNo, seasonCd ];
        				this.close(this.opener.returnOrderNo(arr));
        			}
        			...
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));
        		}else if(this.parent.p_arg == "RTREArrears"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));
        		}else if(this.parent.p_arg == "RTREArrearsResult"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));	
        		}else if(this.parent.p_arg == "RTSDBillModify"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));
        		}else if(this.parent.p_arg == "RTSDCustCondition"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));	
        		}else if(this.parent.p_arg == "RTRECollectionMoney"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));	
        		}else if(this.parent.p_arg == "RTCSAdviceStatus"){
        			var custNo = nvl(this.ds_ordNoList.getColumn(pos, "custNo"));
        			var ordNo  = nvl(this.ds_ordNoList.getColumn(pos, "ordNo"));
        			this.close(this.opener.returnOrderNoInfo(ordNo,custNo));
        		}else if(this.parent.p_arg == "RTSDClaimMgmt_pop"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));	
        		}else if(this.parent.p_arg == "RTCOMMDeliveryBoard_pop"){
        			var ordNo = this.ds_ordNoList.getColumn(pos, "ordNo");
        			this.close(this.opener.returnOrderNo(ordNo));	
        		}else{
        			this.ds_ordNoListCp.clearData();
        			var idx = this.ds_ordNoListCp.addRow();
        			this.ds_ordNoListCp.copyRow(idx, this.ds_ordNoList, pos);
        ...
        this.loadIncludeScript("RTCOMMOrderNo_pop.xfdl");
