    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREAllowance");
                this.set_classname("test");
                this.set_titletext("충당금 설정처리");
        ...
        // User Script
        this.addIncludeScript("RTREAllowance.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAllowance.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 수수료 > 충당금 설정처리
         * 02. 그룹명   : RTREAllowance.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_aggregate  = function() {
        		...
        		if(this.fn_valid()) {
        			...
        			var sSvcID      	= "allowanceAggregate";  
        			var sController   	= "/ntrms/re/allowanceAggregate.do";
        			var sInDatasets   	= "";
        			var sOutDatasets  	= "";
        			var sArgs 			= "";	
        			var fn_callBack		= "fn_callBack";
        	...
        	***********************************************************************************/
        	...
        	{ 
        		if (nErrorCode < 0) 
        		{
        			if(strSvcId == "allowanceAggregate") {
        ...
        this.loadIncludeScript("RTREAllowance.xfdl");
