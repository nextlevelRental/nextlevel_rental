...
function fn_imageUp5() {
	if(fileCheck(document.editor_upimage5.Filedata.value)){
...
function fileCheck(fileValue){
	...
	if(!(src.toLowerCase() == "jpg"
			...
			|| src.toLowerCase() == "png"
			|| src.toLowerCase() == "bmp")){
    	alert("이미지 파일만 등록할 수 있습니다.(JPG, GIF, PNG, BMP)");
    	return false;
	}
	return true;
}   
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
		...
		<div id="pop_footer">
		    <div class="btn_area">
	            <a href="javascript:fn_imageUp();"><img src="../../img/photoQuickPopup/btn_confirm2.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
        ...
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox" name="Filedata" size="40">
            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
        </div>
		</form>
		...
		<div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp5();"><img src="../../img/photoQuickPopup/btn_confirm2.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
