    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTSDValueProductAddPopup");
                this.set_classname("Authority");
                this.set_titletext("부가제품추가팝업");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"90\"/><Column size=\"240\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"70\"/><Column size=\"0\"/><Column size=\"70\"/><Column size=\"350\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"부가제품코드\"/><Cell col=\"2\" text=\"부가제품명\"/><Cell col=\"3\" text=\"제조사\"/><Cell col=\"4\" text=\"금액\"/><Cell col=\"5\" text=\"할인금액\"/><Cell col=\"6\" text=\"실판매금액\"/><Cell col=\"7\" text=\"제품군\"/><Cell col=\"8\" text=\"사용구분\"/><Cell col=\"9\" text=\"할부여부\"/><Cell col=\"10\" text=\"제품설명\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:chk\"/><Cell col=\"1\" text=\"bind:addGdsCd\"/><Cell col=\"2\" edittype=\"none\" style=\"align:left;\" text=\"bind:addGdsNm\"/><Cell col=\"3\" edittype=\"none\" style=\"align:left;\" text=\"bind:makerNm\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:amt\" mask=\"###,###,###,##0\"/><Cell col=\"5\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:dcAmt\" mask=\"###,###,###,##0\"/><Cell col=\"6\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:actAmt\" mask=\"###,###,###,##0\"/><Cell col=\"7\" displaytype=\"combo\" edittype=\"none\" text=\"bind:gdsGrp\" combodataset=\"comGrp\" combocodecol=\"cd\" combodatacol=\"cdNm\" calendardisplaynulltype=\"none\"/><Cell col=\"8\" displaytype=\"combo\" edittype=\"combo\" text=\"bind:useYn\" combodataset=\"ds_yn\" combocodecol=\"cd\" combodatacol=\"cdNm\" calendardisplaynulltype=\"none\"/><Cell col=\"9\" displaytype=\"combo\" text=\"bind:dcYn\" combodataset=\"ds_dcYn\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"10\" edittype=\"none\" style=\"align:left;\" text=\"bind:gdsDesc\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDValueProductAddPopup.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDValueProductAddPopup.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 부가제품추가 팝업
         * 02. 그룹명   : 주문관리-주문관리
         * 03. 그룹설명 :
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("RTSDValueProductAddPopup.xfdl");
