...
nohup ${JAVA_HOME}/bin/java -server -Dsvc=SecureConnector -Dlog4j.configuration=log4j.properties -Dbatch.prop=system.prop com.nice.secureconnector.SecureConnector &
