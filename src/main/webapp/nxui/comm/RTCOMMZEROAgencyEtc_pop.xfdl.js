(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("RTCOMMZEROAgencyEtc_pop.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMZEROAgencyEtc_pop.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMZEROAgencyEtc_pop.xfdl");
