    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECashReceiptResultProc_tab1");
                this.set_classname("re00050_cms");
                this.set_titletext("[STEP1] 결과파일 반영");
            ...
            obj = new Static("Static08", "absolute", "10", "101", "138", "31", null, null, this);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_fileSvrLoc", "absolute", "153", "136", "491", "21", null, null, this);
            obj.set_taborder("18");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "10", "131", "138", "31", null, null, this);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_locPos", "absolute", "18", "108", "128", "20", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdo_svrPos", "absolute", "18", "137", "128", "20", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static21", "absolute", "10", "76", "150", "20", null, null, this);
            obj.set_taborder("22");
            ...
            obj = new FileUpload("FileUpload00", "absolute", "153", "105", "491", "25", null, null, this);
            obj.set_taborder("26");
            ...
            obj = new Static("sta_fileDesc", "absolute", "657", "107", "447", "20", null, null, this);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_text");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_fileNm", "absolute", "154", "106", "420", "21", null, null, this);
            obj.set_taborder("28");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTRECashReceiptResultProc_tab1.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECashReceiptResultProc_tab1.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTRECashReceiptResultProc_tab1.xfdl");
