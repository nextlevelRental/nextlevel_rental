...
/*******************************************************************************
   ...
   1.5        2024-11-22  10244015		   [20241122] 집계 성능 개선을 위한 채권매각테이블 조건 제외
*******************************************************************************/
...
--       AND  A.ORD_NO NOT IN ('O15000024060')                                    --가상계좌 이중발급 출금으로 전금예정건  출금예외처리 (2018.02.12~2018.04.02)
       ...
       AND  A.ORD_NO NOT IN (                                                   --[20190508_01] 출금제외를위한 임시테이블 추가 
                ...
                WHERE PAY_MTHD = 'A'
                AND USE_YN = 'Y')
--       AND  NOT EXISTS (SELECT 1 FROM RTTEMPIWJ_190429_01 WHERE COL_01 = A.ORD_NO) --[20241122] 집계 성능 개선을 위한 채권매각테이블 조건 제외
