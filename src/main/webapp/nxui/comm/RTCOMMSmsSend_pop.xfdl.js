(function()
{
    return function()
    {
        ...
        // 			sndMsg += "-. 가족카드 제외, 동일카드 재발급/ 기 보유 회원 및 해지 후 1년 미경과자 제외";
        		...
        		case "0102":
        // 			sndMsg  = "[제휴카드] 넥센타이어 우리카드 전용 ARS 1800-0635 번";
        // 			sndMsg += "\n또는 모바일 카드신청 URL주소 https://bit.ly/3r1Kh6O 통해 카드신청";
        // 			sndMsg += "\n발급후 넥센고객센터(1855-0100) 연락주셔서 결제변경 꼭 부탁드립니다.";
        //          sndMsg  = "[제휴카드] 넥센타이어 우리카드 전용 ARS 1800-0635 번";
        			sndMsg  = "[제휴카드] 넥센타이어 우리카드 전용 ARS 1800-4136 번";
        			sndMsg += "\n카드 발급후 넥센고객센터(1855-0100) 연락주셔서 결제변경 꼭 부탁드립니다.";
        			this.fMsgId = "S014";
        ...
        this.btn_send_onclick = function(obj,e) {
        	...
        	if (confirm("발송하시겠습니까?")) {
        		...
        		sArgs += Ex.util.setParam("sndMsg"      , encodeURIComponent(this.ta_smsMsg.value));	// 메시지내용 (최대 2000 byte)
