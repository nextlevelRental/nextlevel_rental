(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"280\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"렌탈지점코드\"/><Cell col=\"1\" text=\"렌탈지점명\"/></Band><Band id=\"body\"><Cell text=\"bind:cd\"/><Cell col=\"1\" text=\"bind:cdNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTCOMMVkbur_pop.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMVkbur_pop.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMVkbur_pop.xfdl");
