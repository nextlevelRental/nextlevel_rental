    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREKCPPayHisCheck_tab2");
        ...
        // User Script
        this.addIncludeScript("RTREKCPPayHisCheck_tab2.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREKCPPayHisCheck_tab2.xfdl", function() {
        ...
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/	
        this.RTREKCPPayHisCheck_tab2_onload = function(obj,e){
        	Ex.core.init(obj); 	
        	this.fn_init();
        }
        ...
        {
            this.addEventHandler("onload", this.RTREKCPPayHisCheck_tab2_onload, this);
            this.div_search.cal_checkDay.addEventHandler("onchanged", this.div_search_cal_checkDay_onchanged, this);

        };

        this.loadIncludeScript("RTREKCPPayHisCheck_tab2.xfdl");
