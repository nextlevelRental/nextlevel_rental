    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("패키지(묶음)해지팝업");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"grpNo\" type=\"STRING\" size=\"256\"/><Column id=\"grpCnt\" type=\"STRING\" size=\"256\"/><Column id=\"dcRate\" type=\"STRING\" size=\"256\"/><Column id=\"dcAmt\" type=\"STRING\" size=\"256\"/><Column id=\"grpStdNm\" type=\"STRING\" size=\"256\"/><Column id=\"dcGb\" type=\"STRING\" size=\"256\"/><Column id=\"dcCd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.getSetter("domainId").set("nexa.search");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_grpNo00", "absolute", "815", "10", "124", "21", null, null, this.div_search);
            obj.set_taborder("27");
            obj.set_maxlength("100");
            obj.set_enable("false");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_grpNo01", "absolute", "847", "10", "124", "21", null, null, this.div_search);
            obj.set_taborder("28");
            obj.set_maxlength("100");
            obj.set_enable("false");
            obj.set_visible("false");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"패키지명\"/><Cell col=\"1\" text=\"패키지번호\"/><Cell col=\"2\" text=\"패키지유형\"/><Cell col=\"3\" text=\"패키지상태\"/><Cell col=\"4\" text=\"최소계약건수\"/><Cell col=\"5\" text=\"현재계약건수\"/><Cell col=\"6\" text=\"패키지할인율\"/><Cell col=\"7\" text=\"패키지할인금액\"/></Band><Band id=\"body\"><Cell edittype=\"none\" style=\"align:left;\" text=\"bind:grpNm\"/><Cell col=\"1\" edittype=\"none\" style=\"align:center;\" text=\"bind:grpNo\"/><Cell col=\"2\" displaytype=\"normal\" edittype=\"none\" text=\"bind:grpStdNm\" combodataset=\"comType\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"3\" displaytype=\"combo\" style=\"align:center;\" text=\"bind:grpSt\" combodataset=\"comGrp\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:dcCd\" mask=\"###,###,###,##0\"/><Cell col=\"5\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:grpCnt\" mask=\"###,###,###,##0\"/><Cell col=\"6\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:dcRate\" mask=\"##0.0%\"/><Cell col=\"7\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:dcAmt\" mask=\"###,###,###,##0\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.style.setStyleValue("align", "disabled", "left middle");
            this.div_ordNoDetail.addChild(obj.name, obj);
            obj = new Edit("ed_custTp", "absolute", "876", "5", "75", "20", null, null, this.div_ordNoDetail);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item14","div_ordNoDetail.ed_custTp","value","ds_ordNoList","custTp");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("RTSDGroupPackageCancel_PopupF.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDGroupPackageCancel_PopupF.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 단체(묶음)해지 팝업
         * 02. 그룹명   : 주문관리
         * 03. 그룹설명 :
        ...
        ***********************************************************************************/
        	...
        	{		
        		var sSvcID        	= "cancelPrice";
        		var sController   	= "/rtms/sd/cancelPrice.do";
        		var sInDatasets   	= "";
        		var sOutDatasets  	= "";
        		var sArgs 			= "";
        		sArgs 			+= Ex.util.setParam("ordNo",   nvl(this.div_ordNoDetail.ed_ordNo.value));
        		var fn_callBack		= "fn_callBack";
        	...
        	//----------------------------------------------------------------------------------
        	// Cancel: 해지 Step1 : Popup
        	//----------------------------------------------------------------------------------
        	
        	this.fn_cancelPricePopup = function(){
        	

        		var ordNo = this.div_ordNoDetail.ed_ordNo.value;
        	/*var matNm = this.ed_SaleProdNm.value;*/
        		var custNo = this.div_ordNoDetail.ed_custNo.value;
        		var custNm  = this.div_ordNoDetail.ed_custNm.value;
        		var bizNo = nvl(this.div_ordNoDetail.ed_custTp.value)=='02'?this.div_ordNoDetail.ed_buslNo.value:this.div_ordNoDetail.ed_birthDay.value;

        		var mobNo = this.div_ordNoDetail.ed_mobNo.value;

        		var regiAmt = "0";

        		var onePymnt = this.resultAmt;
        		var p_recpTp	    = "42";
        		
        		
        		if(onePymnt != '0' || onePymnt != 0){	
        			var args = {"ordNo": ordNo, "custNm": custNm, "mobNo" :mobNo, "regiAmt" : regiAmt, "onePymnt" : onePymnt, "custNo" : custNo, "bizNo" : bizNo , "recpTp" : p_recpTp};
        	...
        	if(!this.fn_cancelValidation())
        		...
        		if( confirm( "해지하시겠습니까?"))
        		{
        			...
        			var sGrpType = this.dsList.getColumn(0, "dcGb"); //단체유형
        			var nRestCnt = nexacro.toNumber(this.dsList.getColumn(0, "grpCnt")); //잔여계약수
        			...
        			for(var i=0;i<this.ds_ordNoList.getRowCount();i++){
        				if(this.ds_ordNoList.getColumn(i,"chk")==1){
        					...
        					this.ds_ordNoListChk.addColumn("grpType", "string");
        					this.ds_ordNoListChk.setColumn(i, "grpType", "F");
        				}else{
        					this.ds_ordNoListChk00.copyRow(this.ds_ordNoListChk00.addRow(),this.ds_ordNoList,i);
        				}
        			}
        			
        			var nCnt = this.ds_ordNoListChk.getRowCount();
        			var nCntCd = nListCnt - nCnt;
        			if(nCntCd >=1)
        			{
        				for(var i=0;i<this.ds_restCnt.getRowCount();i++){
        					if(this.ds_restCnt.getColumn(i,"minCnt")<=nCntCd){
        						if(this.ds_restCnt.getColumn(i,"maxCnt")>=nCntCd){
        							if(this.div_search.edt_grpNo00.value!=this.ds_restCnt.getColumn(i,"dcCd")){
        								this.div_search.edt_grpNo01.set_value(this.ds_restCnt.getColumn(i,"dcCd"));
        								this.fn_cancelOrdNo2();
        							}
        							else{
        								this.fn_cancelOrdNo();
        							}
        			...
        			else
        			{
        				for(var i=0;i<this.ds_ordNoListChk.getRowCount();i++){
        					...
        					this.ds_ordNoListChk.setColumn(i, "grpSt", "Y");
        				}
        				this.fn_cancelOrdNo();
        				}
        			}					
        	...
        	this.fn_cancelOrdNo = function(){
        	this.ds_ordNoListChk.addColumn("grpType", "string");
        	for(var i=0;i<this.ds_ordNoListChk.getRowCount();i++){
        		this.ds_ordNoListChk.setColumn(i, "grpType", 'F');
        		this.ds_ordNoListChk.setColumn(i,"dcCd",nvl(this.div_search.edt_grpNo00.value));
        	}
        	...
        	this.fn_cancelOrdNo2 = function(){
        	this.ds_ordNoListChk00.addColumn("grpType", "string");
        	this.ds_ordNoListChk.addColumn("grpType", "string");
        	this.ds_ordNoListChk.addColumn("dcCd", "string");
        	for (var i=0; i<this.ds_ordNoListChk00.getRowCount();i++){		
        		this.ds_ordNoListChk00.setColumn(i, "grpType", 'F');
        		this.ds_ordNoListChk00.setColumn(i,"dcCd", nvl(this.div_search.edt_grpNo01.value));
        	}
        	...
        	for (var i=0; i<this.ds_ordNoListChk.getRowCount();i++){		
        		...
        		var sSvcID        	= "cancelPackage";
        		var sController   	= "/rtms/sd/cancelPackage.do";
        		var sInDatasets   	= "";
        		var sOutDatasets  	= "";
        		var sArgs 			= "";
        	...
        	***********************************************************************************/
        	...
        	{ 
        		...
        		if (strSvcId == "listCommInfo") { //공통코드
        			...
        			this.div_search.edt_grpNo00.set_value(this.dsList.getColumn(0,"dcCd"));
        // 			for(var i=0;i<this.ds_restCnt.getRowCount();i++){
        // 			if(this.div_search.edt_grpNo00.value==this.ds_restCnt.getColumn(i,"dcCd")){
        // 					if(this.ds_restCnt.getColumn(i,"minCnt")<=this.div_search.edt_grpNo00.value){
        // 						
        // 					}
        // 				}
        // 			}
        		...
        		if( strSvcId =="cancelPackage"){
        			alert(strErrorMsg);
        			this.fn_search();
        			this.fn_searchContract();
        		}
        		
        		if( strSvcId =="cancelPrice" ){
        			if( confirm( "위약금은 " + this.resultAmt +"원 입니다. 해지하시겠습니까?")){
        				this.fn_cancelPricePopup();	
        			}
        		}
        	}
        ...
        ***********************************************************************************/
        ...
        this.grid_ordNoList_oncellclick = function(obj,e)
        {
        	for (var i=0; i<=this.ds_ordNoList.rowcount; i++) {
        		if(this.ds_ordNoList.rowposition == i) {
        			this.ds_ordNoList.setColumn(this.ds_ordNoList.rowposition ,"chk","1");
        		}else {
        			this.ds_ordNoList.setColumn(i,"chk","0");
        		}
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.edt_grpNo00.addEventHandler("onkeyup", this.div_search_edt_prodNm_onkeyup, this);
            this.div_search.edt_grpNo01.addEventHandler("onkeyup", this.div_search_edt_prodNm_onkeyup, this);
            ...
            this.div_ordNoDetail.ed_custTp.addEventHandler("onkeyup", this.div_search_edt_searchKeyword_onkeyup, this);

        };

        this.loadIncludeScript("RTSDGroupPackageCancel_PopupF.xfdl");
