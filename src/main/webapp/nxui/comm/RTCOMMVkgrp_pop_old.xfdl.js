(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"280\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"지사코드\"/><Cell col=\"1\" text=\"지사명\"/></Band><Band id=\"body\"><Cell text=\"bind:cd\"/><Cell col=\"1\" text=\"bind:cdNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTCOMMVkgrp_pop_old.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMVkgrp_pop_old.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMVkgrp_pop_old.xfdl");
