...
@Repository("rTCMTestPriceInputMapDAO")

public class RTCMTestPriceInputMapDAO extends RtcmAbstractDAO {
	Logger logger = Logger.getLogger(TableMetaDataAspectJ.class);

	public List<Map> listProductAndPriceInfo(Map inVar) throws Exception {
		getSqlMapClientTemplate().queryForObject("testprice.listPriceInfo", inVar);
