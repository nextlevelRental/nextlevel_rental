    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECrdTranProc_tab2");
                this.set_classname("re00050_cms");
                this.set_titletext("[STEP2] 카드이체대상조회");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/><Row size=\"30\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"카드이체일자\"/><Cell col=\"1\" text=\"카드사코드\"/><Cell col=\"2\" text=\"카드사명\"/><Cell col=\"3\" text=\"처리상태\"/><Cell col=\"4\" text=\"건수\"/><Cell col=\"5\" text=\"금액\"/></Band><Band id=\"body\"><Cell displaytype=\"date\" text=\"bind:rcrdDay\" calendardisplay=\"edit\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" edittype=\"none\" text=\"bind:cardcomCd\"/><Cell col=\"2\" text=\"bind:cardcomNm\"/><Cell col=\"3\" edittype=\"none\" text=\"bind:rqstStatNm\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right middle;\" text=\"bind:rqcnt\" mask=\"###,###,###,##0\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right middle;\" text=\"bind:rqAmt\" mask=\"###,###,###,##0\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" text=\"총계\"/><Cell col=\"2\" style=\"align:right middle;\"/><Cell col=\"3\" style=\"align:right middle;\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right middle;\" text=\"expr:comp.parent.ds_list.getSum(&quot;rqcnt&quot;)\" mask=\"###,###,###,##0\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right middle;\" text=\"expr:comp.parent.ds_list.getSum(&quot;rqAmt&quot;)\" mask=\"###,###,###,##0\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1147, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("[STEP2] 카드이체대상조회");
        ...
        // User Script
        this.addIncludeScript("RTRECrdTranProc_tab2.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECrdTranProc_tab2.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 카드이체관리 > 카드이체처리 > [STEP2] 카드이체 대상조회
         * 02. 그룹명   : RTRECrdTranProc_tab2.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_saveConfirm = function() {
        		...
        		sArgs += Ex.util.setParam("rqstDay"	, nvl(this.ds_list.getColumn(this.ds_list.rowposition,"rcrdDay")));		//카드이체일자	
        ...
        this.loadIncludeScript("RTRECrdTranProc_tab2.xfdl");
