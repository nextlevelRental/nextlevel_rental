    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRESETTLEVanHisCheck_tab2");
        ...
        // User Script
        this.addIncludeScript("RTRESETTLEVanHisCheck_tab2.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRESETTLEVanHisCheck_tab2.xfdl", function() {
        ...
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/	
        this.RTRESETTLEVanHisCheck_tab2_onload = function(obj,e){
        	Ex.core.init(obj); 	
        	this.fn_init();
        }
        ...
        this.fn_search = function(){
        	...
        	var sSvcID        	= "selectSRtre0046";                    
        	var sController   	= "rtms/re/selectSRtre0046.do";
        	var sInDatasets   	= "";
        	var sOutDatasets  	= "";
        	var sArgs 			= "";	
        	var fn_callBack		= "fn_callBack";
        	sOutDatasets += " ds_list=selectSRtre0046Map ";
        ...
        {
            this.addEventHandler("onload", this.RTRESETTLEVanHisCheck_tab2_onload, this);
            this.div_search.cal_checkDay.addEventHandler("onchanged", this.div_search_cal_checkDay_onchanged, this);

        };

        this.loadIncludeScript("RTRESETTLEVanHisCheck_tab2.xfdl");
