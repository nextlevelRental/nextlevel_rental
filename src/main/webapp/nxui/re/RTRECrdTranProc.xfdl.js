    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECrdTranProc");
                this.set_classname("re00050_cms");
                this.set_titletext("카드이체처리");
            ...
            obj.set_text("[STEP 1] 카드이체 대상집계");
            obj.set_url("re::RTRECrdTranProc_tab1.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab02);
            obj.set_text("[STEP 2] 카드이체 대상조회");
            obj.set_url("re::RTRECrdTranProc_tab2.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage3", this.Tab02);
            obj.set_text("[STEP 3] 파일 생성");
            obj.set_url("re::RTRECrdTranProc_tab3.xfdl");
            this.Tab02.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "re::RTRECrdTranProc_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTRECrdTranProc_tab2.xfdl");
            this._addPreloadList("fdl", "re::RTRECrdTranProc_tab3.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTRECrdTranProc.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECrdTranProc.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 카드이체관리 > 카드이체처리
         * 02. 그룹명   : RTRECrdTranProc.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTRECrdTranProc.xfdl");
