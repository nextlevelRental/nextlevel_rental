    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECrdTran_tab1");
                this.set_classname("re00050_cms");
                this.set_titletext("계약번호별 내역조회(카드이체)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"rcrdDay\" type=\"STRING\" size=\"256\"/><Column id=\"ordNo\" type=\"STRING\" size=\"256\"/><Column id=\"custNo\" type=\"STRING\" size=\"256\"/><Column id=\"custNm\" type=\"STRING\" size=\"256\"/><Column id=\"rcrdAmt\" type=\"STRING\" size=\"256\"/><Column id=\"recpAmt\" type=\"STRING\" size=\"256\"/><Column id=\"crercd\" type=\"STRING\" size=\"256\"/><Column id=\"crernm\" type=\"STRING\" size=\"256\"/><Column id=\"cardcomCd\" type=\"STRING\" size=\"256\"/><Column id=\"cardcomNm\" type=\"STRING\" size=\"256\"/><Column id=\"cardNo\" type=\"STRING\" size=\"256\"/><Column id=\"rqstStat\" type=\"STRING\" size=\"256\"/><Column id=\"rqstStatNm\" type=\"STRING\" size=\"256\"/><Column id=\"rcrdSeq\" type=\"STRING\" size=\"256\"/><Column id=\"recvSeq\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Grid("grd_list", "absolute", "10", "134", "1092", "322", null, null, this);
            obj.set_taborder("15");
            obj.set_binddataset("ds_list");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"98\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/><Row size=\"30\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"출금일자\"/><Cell col=\"1\" text=\"계약번호\"/><Cell col=\"2\" text=\"고객코드\"/><Cell col=\"3\" text=\"고객명\"/><Cell col=\"4\" text=\"청구금액\"/><Cell col=\"5\" text=\"수납금액\"/><Cell col=\"6\" text=\"오류코드\"/><Cell col=\"7\" text=\"오류명\"/><Cell col=\"8\" text=\"카드사코드\"/><Cell col=\"9\" text=\"카드사명\"/><Cell col=\"10\" text=\"카드번호\"/><Cell col=\"11\" text=\"신청상태\"/></Band><Band id=\"body\"><Cell displaytype=\"date\" text=\"bind:rcrdDay\" calendardisplay=\"edit\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"readonly\" text=\"bind:ordNo\" calendardisplay=\"display\"/><Cell col=\"2\" text=\"bind:custNo\" calendardisplay=\"display\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" text=\"bind:custNm\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right middle;cursor:hand;selectline: ;\" text=\"bind:rcrdAmt\" mask=\"###,###,###,##0\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right middle;cursor:hand;\" text=\"bind:recpAmt\" mask=\"###,###,###,##0\"/><Cell col=\"6\" text=\"bind:crercd\"/><Cell col=\"7\" text=\"bind:crernm\"/><Cell col=\"8\" text=\"bind:cardcomCd\"/><Cell col=\"9\" text=\"bind:cardcomNm\"/><Cell col=\"10\" text=\"bind:cardNo\"/><Cell col=\"11\" text=\"bind:rqstStatNm\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" text=\"총계\"/><Cell col=\"2\" style=\"align:right middle;\"/><Cell col=\"3\" style=\"align:right middle;\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right middle;\" text=\"expr:comp.parent.ds_list.getSum(&quot;rcrdAmt&quot;)\" mask=\"###,###,###,##0\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right middle;\" text=\"expr:comp.parent.ds_list.getSum(&quot;recpAmt&quot;)\" mask=\"###,###,###,##0\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/><Cell col=\"9\"/><Cell col=\"10\"/><Cell col=\"11\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_cssclass("btn_WF_edtSch");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_custNoKeyword", "absolute", "589", "45", "160", "21", null, null, this.div_search);
            obj.set_taborder("97");
            obj.set_inputfilter("space");
            obj.set_lengthunit("ascii");
            ...
            obj = new Static("Static05", "absolute", "0", "456", "1122", "40", null, null, this);
            obj.set_taborder("23");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            obj.style.set_background("aqua");
            ...
            obj = new Layout("default", "", 1122, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("계약번호별 내역조회(카드이체)");
        ...
        // User Script
        this.addIncludeScript("RTRECrdTran_tab1.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECrdTran_tab1.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > CMS관리 > 카드이체조회 > 계약번호별 내역조회
         * 02. 그룹명   : RTRECrdTran_tab1.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_search = function()
        	{
        		if(this.fn_getValidRcmsDay()) {
        			var sSvcID      	= "getCrdTranOrdNoList";  
        			...
        			sArgs += Ex.util.setParam("rcrdDayF", nvl(this.div_search.cal_fromDt.value));		
        			sArgs += Ex.util.setParam("rcrdDayT", nvl(this.div_search.cal_toDt.value));		
        	...
        	***********************************************************************************/
        	...
        	this.grd_list_oncelldblclick = function(obj,e)
        	{
        		...
        		if(colText=="청구금액") {
        		  var sRcrdDay = this.ds_list.getColumn(this.ds_list.rowposition,"rcrdDay");	//카드이체일자
        		  var sRcrdSeq = this.ds_list.getColumn(this.ds_list.rowposition,"rcrdSeq");	//카드이체일련번호
        		  var args ={p_rcrdDay:sRcrdDay, p_rcrdSeq:sRcrdSeq};
        		  Ex.core.popup(this,"청구세부조회","comm::RTCOMMCrdTranDtl_pop.xfdl",args,"modaless=false");	
        		}
        		if(colText=="수납금액") {
        		  var sRecvSeq = this.ds_list.getColumn(this.ds_list.rowposition,"recvSeq");	//수납거래번호
        		  var args ={p_recvSeq:sRecvSeq, p_gubun:"card"};
        ...
        this.loadIncludeScript("RTRECrdTran_tab1.xfdl");
