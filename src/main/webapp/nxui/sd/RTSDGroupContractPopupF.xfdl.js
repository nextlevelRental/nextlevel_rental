(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"0\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"85\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"패키지번호\"/><Cell col=\"1\" text=\"패키지유형\"/><Cell col=\"2\" text=\"최소약정본수\"/><Cell col=\"3\" text=\"현재계약건수\"/><Cell col=\"4\" text=\"패키지할인율\"/><Cell col=\"5\" text=\"패키지할인금액\"/></Band><Band id=\"body\"><Cell edittype=\"none\" style=\"align:center;\" text=\"bind:grpNo\"/><Cell col=\"1\" displaytype=\"normal\" style=\"align:center;\" text=\"bind:grpStdNm\" combodataset=\"comGrp\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"2\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" mask=\"###,###,###,##0\"/><Cell col=\"3\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:grpCnt\" mask=\"###,###,###,##0\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:dcRate\" mask=\"##0.0%\"/><Cell col=\"5\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:dcAmt\" mask=\"###,###,###,##0\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WF_detailLabel2");
            this.div_ordNoDetail.addChild(obj.name, obj);
            obj = new Static("st_matNm01", "absolute", "0", "150", "150", "31", null, null, this.div_ordNoDetail);
            obj.set_taborder("148");
            obj.set_text("판매상품명");
            obj.set_cssclass("sta_WF_detailLabel");
            obj.getSetter("domainId").set("nexa.s_condition");
            this.div_ordNoDetail.addChild(obj.name, obj);
            obj = new Edit("ed_seasonCd00", "absolute", "155", "155", "200", "20", null, null, this.div_ordNoDetail);
            obj.set_taborder("149");
            obj.set_enable("false");
            this.div_ordNoDetail.addChild(obj.name, obj);
            obj = new Static("st_matNm02", "absolute", "0", "180", "150", "31", null, null, this.div_ordNoDetail);
            obj.set_taborder("150");
            obj.set_text("월렌탈료");
            obj.set_cssclass("sta_WF_detailLabel");
            obj.getSetter("domainId").set("nexa.s_condition");
            this.div_ordNoDetail.addChild(obj.name, obj);
            obj = new MaskEdit("mae_seasonCd01", "absolute", "155", "185", "200", "20", null, null, this.div_ordNoDetail);
        ...
        // User Script
        this.addIncludeScript("RTSDGroupContractPopupF.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDGroupContractPopupF.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 단체계약조회 팝업
         * 02. 그룹명   : 주문관리
         * 03. 그룹설명 :
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("RTSDGroupContractPopupF.xfdl");
