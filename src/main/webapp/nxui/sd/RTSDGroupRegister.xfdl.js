(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("st_searchCondition01", "absolute", "238", "12", "80", "20", null, null, this.div_search);
            obj.set_taborder("20");
            obj.set_text("단체번호");
            obj.set_cssclass("sta_WF_schTitle");
            obj.getSetter("domainId").set("nexa.s_condition");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_grpNo", "absolute", "310", "10", "140", "21", null, null, this.div_search);
            obj.set_taborder("1");
            obj.set_enable("true");
            ...
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_grpNm", "absolute", "87", "10", "124", "21", null, null, this.div_search);
            obj.set_taborder("0");
            obj.set_enable("true");
            obj.set_maxlength("100");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static24", "absolute", "213", "0", "25", "44", null, null, this);
            obj.set_taborder("28");
            obj.set_text("FIX \r\nw30");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
        ...
        // User Script
        this.addIncludeScript("RTSDGroupRegister.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDGroupRegister.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 단체정보등록
         * 02. 그룹명   : 주문관리
         * 03. 그룹설명 :
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("RTSDGroupRegister.xfdl");
