...
<script language="javascript">
	...
	function setSafeKey() {
		//typeof top.opener.opener;
		//alert(top.opener.document);
...
<body>
    ...
    <input type="button" id="saveNewSafekey"  value="결과저장" name="saveNewSafekey" onclick="setSafeKey();">
    <br>        
    <%= sMessage %><br>
    </center>
</body>
