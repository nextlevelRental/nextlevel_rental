    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTSDNoMadeOrderList");
                this.set_classname("RTCSHappyCallRegister");
                this.set_titletext("신규 오더 미생성 리스트");
            ...
            obj.getSetter("domainId").set("nexa.s_condition");
            this.Div00.addChild(obj.name, obj);
            obj = new Edit("ed_salesOffice", "absolute", "499", "11", "68", "21", null, null, this.Div00);
            obj.set_taborder("53");
            this.Div00.addChild(obj.name, obj);
            obj = new Button("bt_salesOfficeCd", "absolute", "567", "10", "21", "21", null, null, this.Div00);
            obj.set_taborder("54");
            obj.set_cssclass("btn_WF_edtSch");
            this.Div00.addChild(obj.name, obj);
            obj = new Edit("ed_salesOfficeNm", "absolute", "589", "11", "118", "21", null, null, this.Div00);
            obj.set_taborder("55");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("150");
            obj.set_enable("false");
            this.Div00.addChild(obj.name, obj);
            obj = new Edit("ed_agencyCd", "absolute", "895", "11", "71", "21", null, null, this.Div00);
            obj.set_taborder("57");
            obj.set_enable("false");
            this.Div00.addChild(obj.name, obj);
            obj = new Button("bt_agency", "absolute", "946", "11", "20", "21", null, null, this.Div00);
            obj.set_taborder("58");
            obj.set_cssclass("btn_WF_edtSch");
            obj.set_enable("true");
            obj.getSetter("domainId").set("nexa.save");
            this.Div00.addChild(obj.name, obj);
            obj = new Edit("ed_agencyNm", "absolute", "966", "11", "71", "21", null, null, this.Div00);
            obj.set_taborder("59");
            obj.set_enable("false");
            this.Div00.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"90\"/><Column size=\"0\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"150\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"120\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"계약번호\"/><Cell col=\"1\" text=\"계약상태\"/><Cell col=\"2\" text=\"휴대폰\"/><Cell col=\"3\" text=\"계약일자\"/><Cell col=\"4\" text=\"장착일자\"/><Cell col=\"5\" text=\"상품코드\"/><Cell col=\"6\" text=\"상품명\"/><Cell col=\"7\" text=\"본수\"/><Cell col=\"8\" text=\"거점\"/><Cell col=\"9\" text=\"재고유형\"/><Cell col=\"10\" text=\"채널\"/><Cell col=\"11\" text=\"채널중분류\"/><Cell col=\"12\" text=\"대리점코드\"/><Cell col=\"13\" text=\"대리점\"/><Cell col=\"14\" text=\"오더번호\"/><Cell col=\"15\" text=\"딜리번리번호\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" text=\"bind:ordNo\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" text=\"bind:statNm\"/><Cell col=\"2\" text=\"bind:mobNo\"/><Cell col=\"3\" displaytype=\"text\" edittype=\"none\" text=\"bind:ordDay\" mask=\"####-##-##\"/><Cell col=\"4\" displaytype=\"text\" text=\"bind:procDay\" mask=\"####-##-##\" calendardisplaynulltype=\"none\"/><Cell col=\"5\" displaytype=\"normal\" text=\"bind:matCd\" calendardisplaynulltype=\"none\"/><Cell col=\"6\" displaytype=\"normal\" text=\"bind:matNm\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" displaytype=\"normal\" text=\"bind:cntNm\" calendardisplaynulltype=\"none\"/><Cell col=\"8\" displaytype=\"normal\" text=\"bind:rcYn\" calendardisplaynulltype=\"none\"/><Cell col=\"9\" text=\"bind:outStockTypeNm\"/><Cell col=\"10\" text=\"bind:chanNm\"/><Cell col=\"11\" text=\"bind:chanMclsNm\"/><Cell col=\"12\" text=\"bind:agencyCd\"/><Cell col=\"13\" text=\"bind:agencyNm\"/><Cell col=\"14\" text=\"bind:vbeln\"/><Cell col=\"15\" text=\"bind:vbelnD\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDNoMadeOrderList.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDNoMadeOrderList.xfdl", function() {
        /***********************************************************************
         * Script Include 
         ************************************************************************/
        ...
        this.fn_search = function(obj,e)
        {
        	...
        	sArgs += Ex.util.setParam("mode", 		"01");
        ...
        ***********************************************************************************/
        ...
        this.return_agency = function(arr) {
        	...
        	this.div_search.ed_salessOfficeNm.set_value(arr[2]);
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.bt_agency.addEventHandler("onclick", this.div_cust_btn_postSearch1_onclick, this);
        ...
        this.loadIncludeScript("RTSDNoMadeOrderList.xfdl");
