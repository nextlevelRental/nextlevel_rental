(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static21", "absolute", "10", "116", "120", "21", null, null, this);
            obj.set_taborder("5");
            obj.set_text("가계약목록");
            obj.set_cssclass("sta_WF_subTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "0", "132", "1122", "10", null, null, this);
            obj.set_taborder("6");
            obj.set_text("FIX h10");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            ...
            obj = new Grid("grid_provsnList", "absolute", "9", "142", "1113", "157", null, null, this);
            obj.set_taborder("9");
            ...
            obj = new Edit("ed_mobNo", "absolute", "417", "380", "142", "21", null, null, this);
            obj.set_taborder("35");
            ...
            obj = new Static("Static03", "absolute", "10", "405", "1113", "31", null, null, this);
            obj.set_taborder("36");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("st_cancDay", "absolute", "434", "435", "82", "31", null, null, this);
            obj.set_taborder("42");
            obj.set_text("월렌탈료");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("st_procDay", "absolute", "270", "435", "82", "31", null, null, this);
            obj.set_taborder("43");
            obj.set_text("렌탈등록비");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("st_planDay", "absolute", "140", "435", "82", "31", null, null, this);
            obj.set_taborder("44");
            obj.set_text("계약기간");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("ed_period", "absolute", "227", "440", "38", "21", null, null, this);
            obj.set_taborder("25");
            ...
            obj = new Edit("ed_regiAmt", "absolute", "357", "440", "72", "21", null, null, this);
            obj.set_taborder("26");
            obj.set_inputtype("number");
            obj.set_readonly("true");
            obj.set_enable("true");
            ...
            obj = new Static("st_ordQty", "absolute", "414", "465", "125", "31", null, null, this);
            obj.set_taborder("47");
            obj.set_text("연락처수집방법");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_emailAddr", "absolute", "267", "470", "142", "21", null, null, this);
            obj.set_taborder("30");
            obj.set_maxlength("100");
            obj.set_readonly("true");
            obj.set_enable("true");
            ...
            obj = new Static("st_matNm", "absolute", "180", "465", "82", "31", null, null, this);
            obj.set_taborder("48");
            obj.set_text("e-mail");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("st_matCd", "absolute", "10", "465", "82", "31", null, null, this);
            obj.set_taborder("49");
            obj.set_text("장착희망일");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_rentAmt", "absolute", "521", "440", "72", "21", null, null, this);
            obj.set_taborder("27");
            obj.set_inputtype("number");
            obj.set_readonly("true");
            obj.set_enable("true");
            ...
            obj = new Edit("ed_contactGet", "absolute", "544", "470", "316", "21", null, null, this);
            obj.set_taborder("31");
            obj.set_maxlength("200");
            obj.set_readonly("true");
            obj.set_enable("true");
            ...
            obj = new Static("st_contractInfo", "absolute", "10", "318", "80", "21", null, null, this);
            obj.set_taborder("51");
            obj.set_text("가계약정보");
            obj.set_cssclass("sta_WF_subTitle");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static06", "absolute", "0", "298", null, "15", "0", null, this);
            obj.set_taborder("52");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            ...
            obj = new Static("Static07", "absolute", "683", "486", "1147", "10", null, null, this);
            obj.set_taborder("53");
            obj.set_cssclass("Guide_color");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("me_planDay", "absolute", "97", "470", "78", "21", null, null, this);
            obj.set_taborder("29");
            obj.set_type("string");
            obj.set_mask("####-##-##");
            obj.set_enable("true");
            ...
            obj = new Button("btn_contact", "absolute", "1077", "313", "45", "22", null, null, this);
            obj.set_taborder("54");
            obj.set_text("상담");
            ...
            obj = new Static("Static09", "absolute", "10", "345", "1113", "31", null, null, this);
            obj.set_taborder("55");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_ordNo", "absolute", "1006", "350", "107", "21", null, null, this);
            obj.set_taborder("16");
            ...
            obj = new Static("st_statNm00", "absolute", "920", "345", "82", "31", null, null, this);
            obj.set_taborder("56");
            obj.set_text("진계약번호");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("st_saleNm00", "absolute", "545", "345", "82", "31", null, null, this);
            obj.set_taborder("57");
            obj.set_text("상태");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_provsnNo", "absolute", "270", "350", "107", "21", null, null, this);
            obj.set_taborder("12");
            obj.set_readonly("true");
            obj.set_maxlength("20");
            obj.set_enable("true");
            ...
            obj = new Static("st_chanNm00", "absolute", "184", "345", "82", "31", null, null, this);
            obj.set_taborder("58");
            obj.set_text("가계약번호");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("st_ordNm00", "absolute", "10", "345", "82", "31", null, null, this);
            obj.set_taborder("59");
            obj.set_text("주문접수일");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("me_provsnDay", "absolute", "96", "350", "84", "21", null, null, this);
            obj.set_taborder("11");
            obj.set_readonly("true");
            obj.set_type("string");
            obj.set_mask("####-##-##");
            ...
            obj = new Static("st_saleNm01", "absolute", "381", "345", "82", "31", null, null, this);
            obj.set_taborder("60");
            obj.set_text("컨택횟수");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Edit("ed_contactCnt", "absolute", "467", "350", "74", "21", null, null, this);
            obj.set_taborder("13");
            obj.set_maxlength("8");
            obj.set_readonly("true");
            obj.set_enable("true");
            ...
            obj = new Combo("cmb_provsnSt", "absolute", "631", "350", "81", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("14");
            ...
            obj = new Combo("cmb_provsnStDtl", "absolute", "716", "350", "200", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("15");
            ...
            obj = new Grid("grid_provsnExcelList", "absolute", "28.6%", "109", null, "147", "35.14%", null, this);
            obj.set_taborder("62");
            ...
            obj = new Edit("ed_contactGet00", "absolute", "694", "440", "419", "21", null, null, this);
            obj.set_taborder("28");
            obj.set_readonly("true");
            obj.set_maxlength("200");
            this.addChild(obj.name, obj);

            obj = new Static("st_matCd00", "absolute", "865", "465", "82", "31", null, null, this);
            obj.set_taborder("64");
            obj.set_text("재컨택일자");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("me_recallDay", "absolute", "952", "470", "78", "21", null, null, this);
            obj.set_taborder("32");
            obj.set_readonly("true");
            obj.set_type("string");
            obj.set_mask("####-##-##");
            ...
            obj = new MaskEdit("me_recallTm", "absolute", "1035", "470", "78", "21", null, null, this);
            obj.set_taborder("33");
            obj.set_readonly("true");
            obj.set_type("string");
            obj.set_mask("##:##");
            ...
            obj = new FileDownload("FileDownload", "absolute", "766", "314", "100", "21", null, null, this);
            obj.set_taborder("65");
            ...
            obj = new Button("btn_img", "absolute", "1028", "313", "45", "22", null, null, this);
            obj.set_taborder("67");
            obj.set_text("이미지");
            obj.set_cssclass("btn_WF_module");
            obj.getSetter("domainId").set("nexa.save");
            ...
            obj = new Tab("tab_cond", "absolute", "0.7%", "0", null, "115", "2.27%", null, this);
            obj.set_taborder("68");
            obj.set_tabindex("0");
