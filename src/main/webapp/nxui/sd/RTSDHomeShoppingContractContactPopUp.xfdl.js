(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            obj = new TextArea("ta_callDtl_copy", "absolute", "0.49%", "2", null, "204", "0.49%", null, this.divCallDtl);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("RTSDHomeShoppingContractContactPopUp.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDHomeShoppingContractContactPopUp.xfdl", function() {
        /***************************************************************************************************
         * 파 일 명 : RTSDHomeShoppingContractContactPopUp.xfdl
         * 설    명 : 홈쇼핑 가계약상담(팝업)
         * 작 성 자 : wjim
         * 변경이력 :
         * 변경일자		변경자		변경내용
        ...
        this.RTSDProvisionalContractContactPopUp_onload = function(obj,e) {
        	...
        	if (this.parent.p_userGrp == "01" || this.parent.p_userGrp == "02" || this.parent.p_userGrp == "13") {
        ...
        this.btn_sndSms_onclick = function(obj,e) {
        	...
        	var arr ={
        		  p_callId : "RTSDHomeShoppingContractContactPopUp"
        		, p_phnNo  : vMobNo
        ...
        this.on_initEvent = function()
        {
            ...
            this.ta_callDtl.addEventHandler("onlbuttonup", this.ta_callDtl_onlbuttonup, this);
        ...
        this.loadIncludeScript("RTSDHomeShoppingContractContactPopUp.xfdl");
