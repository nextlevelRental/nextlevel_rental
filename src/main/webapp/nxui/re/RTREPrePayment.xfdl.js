    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREPrePayment");
                this.set_classname("re00050_cms");
                this.set_titletext("선수금 관리");
            ...
            obj.set_text("선수금 관리 - 계약별");
            obj.set_url("re::RTREPrePayment_tab1.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab02);
            obj.set_text("선수금 정리 처리");
            obj.set_url("re::RTREPrePayment_tab2.xfdl");
            this.Tab02.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "re::RTREPrePayment_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTREPrePayment_tab2.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTREPrePayment.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREPrePayment.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 마감관리 > 선수금관리
         * 02. 그룹명   : RTREPrePayment.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        this.loadIncludeScript("RTREPrePayment.xfdl");
