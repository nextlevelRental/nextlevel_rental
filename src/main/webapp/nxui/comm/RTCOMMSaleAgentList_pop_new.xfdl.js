(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("ed_saleAgent", "absolute", "116", "10", "100", "21", null, null, this.div_search);
            obj.set_taborder("83");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cb_chanCd", "absolute", "329", "43", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("95");
            ...
            obj.set_index("0");
            obj = new Static("Static06", "absolute", "257", "43", "80", "21", null, null, this.div_search);
            obj.set_taborder("96");
            obj.set_text("채널구분");
            obj.set_cssclass("sta_WF_schTitle");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("ed_saleOffice", "absolute", "115", "43", "100", "21", null, null, this.div_search);
            obj.set_taborder("97");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("st_warehCd00", "absolute", "20", "45", "88", "20", null, null, this.div_search);
            obj.set_taborder("98");
            obj.set_text("렌탈지점코드");
            obj.set_cssclass("sta_WF_schTitle");
            obj.getSetter("domainId").set("nexa.s_condition");
            ...
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("st_warehCd01", "absolute", "483", "11", "88", "20", null, null, this.div_search);
            obj.set_taborder("102");
            obj.set_text("렌탈지사코드");
            obj.set_cssclass("sta_WF_schTitle");
            obj.getSetter("domainId").set("nexa.s_condition");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("ed_saleGroup", "absolute", "576", "11", "100", "21", null, null, this.div_search);
            obj.set_taborder("103");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("st_warehCd02", "absolute", "480", "43", "80", "20", null, null, this.div_search);
            obj.set_taborder("104");
            obj.set_text("벤터코드");
            obj.set_cssclass("sta_WF_schTitle");
            obj.getSetter("domainId").set("nexa.s_condition");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("ed_lifnr", "absolute", "578", "42", "100", "21", null, null, this.div_search);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"140\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"판매처코드\"/><Cell col=\"1\" text=\"판매처명\"/><Cell col=\"2\" text=\"렌탈지사\"/><Cell col=\"3\" text=\"렌탈지점\"/><Cell col=\"4\" text=\"전화번호\"/><Cell col=\"5\" text=\"채널구분\"/><Cell col=\"6\" text=\"벤더코드\"/><Cell col=\"7\" text=\"세금계산서 발행방법\"/></Band><Band id=\"body\"><Cell text=\"bind:agencyCd\"/><Cell col=\"1\" text=\"bind:agencyNm\"/><Cell col=\"2\" text=\"bind:salesGroup\"/><Cell col=\"3\" text=\"bind:salesOffice\"/><Cell col=\"4\" text=\"bind:telNo\"/><Cell col=\"5\" text=\"bind:chanCd\"/><Cell col=\"6\" text=\"bind:lifnr\"/><Cell col=\"7\" text=\"bind:taxRqcd\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTCOMMSaleAgentList_pop_new.xfdl", "lib::comLib.xjs");
        this.registerScript("RTCOMMSaleAgentList_pop_new.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTCOMMSaleAgentList_pop_new.xfdl");
