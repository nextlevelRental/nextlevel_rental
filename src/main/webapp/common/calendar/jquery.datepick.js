...
$.extend(Datepick.prototype, {
		...
		if (showOn == 'button' || showOn == 'both') { // Pop-up date picker when button clicked
			...
			var trigger = $(this._get(inst, 'buttonImageOnly') ?
				$('<img/>').addClass(this._triggerClass[useTR]).
					attr({src: buttonImage, style:'cursor:hand', alt: buttonText, title: buttonText}) :
				$('<button type="button" style="cursor:hand;"></button>').addClass(this._triggerClass[useTR]).
	...
	_generateHTML: function(inst) {
		...
		html += (showStatus ? '<div style="clear: both;"></div><div id="' + this._statusId[useTR] +
			...
			($.browser.msie && parseInt($.browser.version, 10) < 10 && !inst.inline ?
