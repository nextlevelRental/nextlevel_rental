    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECashReceiptResultProc_tab2");
                this.set_classname("re00050_cms");
                this.set_titletext("[STEP2] 결과파일 반영조회");
            ...
            obj = new Static("Static17", "absolute", "10", "412", "1092", "31", null, null, this);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_procStatus", "absolute", "144", "417", "953", "21", null, null, this);
            obj.set_taborder("13");
            ...
            obj = new Layout("default", "", 1122, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("[STEP2] 결과파일 반영조회");
        ...
        // User Script
        this.addIncludeScript("RTRECashReceiptResultProc_tab2.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECashReceiptResultProc_tab2.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTRECashReceiptResultProc_tab2.xfdl");
