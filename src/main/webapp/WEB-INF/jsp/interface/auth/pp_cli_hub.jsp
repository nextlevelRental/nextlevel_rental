...
%>
    ...
    <%@ include file="/offline_batch_windows_jsp/cfg/site_conf_inc.jsp"%>
<%
	...
	ds.addColumn(new ColumnHeader("batchKey", 		DataTypes.STRING));
	ds.addColumn(new ColumnHeader("pay_type", 		DataTypes.STRING));
	ds.addColumn(new ColumnHeader("pay_id", 		DataTypes.STRING));
