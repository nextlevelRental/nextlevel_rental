    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREKCPDirectHisCheck_tab2");
                this.set_classname("RTREKCPPayHisCheck_tab2");
                this.set_titletext("[STEP2]KCP결제내역조회");
            ...
            obj = new Layout("default", "", 1147, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("[STEP2]KCP결제내역조회");
        ...
        // User Script
        this.addIncludeScript("RTREKCPDirectHisCheck_tab2.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREKCPDirectHisCheck_tab2.xfdl", function() {
        ...
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/	
        this.RTREKCPDirectHisCheck_tab2_onload = function(obj,e){
        	Ex.core.init(obj); 	
        	this.fn_init();
        }
        ...
        this.fn_search = function(){
        	...
        	var sSvcID        	= "selectSRtre0044";                    
        	var sController   	= "rtms/re/selectSRtre0044.do";
        	var sInDatasets   	= "";
        	var sOutDatasets  	= "";
        	var sArgs 			= "";	
        	var fn_callBack		= "fn_callBack";
        	sOutDatasets += " ds_list=selectSRtre0044Map ";
        ...
        {
            this.addEventHandler("onload", this.RTREKCPDirectHisCheck_tab2_onload, this);
            this.div_search.cal_checkDay.addEventHandler("onchanged", this.div_search_cal_checkDay_onchanged, this);

        };

        this.loadIncludeScript("RTREKCPDirectHisCheck_tab2.xfdl");
