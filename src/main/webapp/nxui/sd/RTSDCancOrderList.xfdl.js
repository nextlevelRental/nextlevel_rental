    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTSDCancOrderList");
                this.set_classname("RTCSHappyCallRegister");
                this.set_titletext("취소 오더 현황 리스트");
                this._setFormPosition(0,0,1147,492);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsS318", this);
            ...
            obj.set_visible("false");
            this.Div00.addChild(obj.name, obj);
            obj = new Combo("cb_deliveryType", "absolute", "44.72%", "44", null, "20", "41.86%", null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("73");
            obj.set_innerdataset("@dsS318");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"90\"/><Column size=\"0\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"150\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"120\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"계약번호\"/><Cell col=\"1\" text=\"계약상태\"/><Cell col=\"2\" text=\"휴대폰\"/><Cell col=\"3\" text=\"계약일자\"/><Cell col=\"4\" text=\"장착일자\"/><Cell col=\"5\" text=\"상품코드\"/><Cell col=\"6\" text=\"상품명\"/><Cell col=\"7\" text=\"본수\"/><Cell col=\"8\" text=\"거점\"/><Cell col=\"9\" text=\"재고유형\"/><Cell col=\"10\" text=\"채널\"/><Cell col=\"11\" text=\"채널중분류\"/><Cell col=\"12\" text=\"대리점코드\"/><Cell col=\"13\" text=\"대리점\"/><Cell col=\"14\" text=\"오더번호\"/><Cell col=\"15\" text=\"출고일자\"/><Cell col=\"16\" text=\"반품오더번호\"/><Cell col=\"17\" text=\"반품딜리버리번호\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" text=\"bind:ordNo\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" text=\"bind:statNm\"/><Cell col=\"2\" text=\"bind:mobNo\"/><Cell col=\"3\" displaytype=\"text\" edittype=\"none\" text=\"bind:ordDay\" mask=\"####-##-##\"/><Cell col=\"4\" displaytype=\"text\" text=\"bind:procDay\" mask=\"####-##-##\" calendardisplaynulltype=\"none\"/><Cell col=\"5\" displaytype=\"normal\" text=\"bind:matCd\" calendardisplaynulltype=\"none\"/><Cell col=\"6\" displaytype=\"normal\" text=\"bind:matNm\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" displaytype=\"normal\" text=\"bind:cntNm\" calendardisplaynulltype=\"none\"/><Cell col=\"8\" displaytype=\"normal\" text=\"bind:rcYn\" calendardisplaynulltype=\"none\"/><Cell col=\"9\" text=\"bind:outStockTypeNm\"/><Cell col=\"10\" text=\"bind:chanNm\"/><Cell col=\"11\" text=\"bind:chanMclsNm\"/><Cell col=\"12\" text=\"bind:agencyCd\"/><Cell col=\"13\" text=\"bind:agencyNm\"/><Cell col=\"14\" text=\"bind:vbeln\"/><Cell col=\"15\" text=\"bind:giDay\"/><Cell col=\"16\" text=\"bind:vbelnR\"/><Cell col=\"17\" text=\"bind:vbelnDR\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDCancOrderList.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDCancOrderList.xfdl", function() {
        /***********************************************************************
         * Script Include 
         ************************************************************************/
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("RTSDCancOrderList.xfdl");
