    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREAccTranProc_tab1");
                this.set_classname("re00050_cms");
                this.set_titletext("[STEP1] 출금이체대상집계");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"결제일\"/><Cell col=\"1\" text=\"당월청구\"/><Cell col=\"2\" text=\"연체청구\"/></Band><Band id=\"body\"><Cell displaytype=\"combo\" text=\"bind:payDd\" combodataset=\"ds_R005\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"1\" displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:curCharge\"/><Cell col=\"2\" displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:delayCharge\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1147, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("[STEP1] 출금이체대상집계");
        ...
        // User Script
        this.addIncludeScript("RTREAccTranProc_tab1.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAccTranProc_tab1.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > CMS관리 > 출금이체처리 > [STEP1] 출금이체대상집계
        ...
        ************************************************************************/
        	...
        	***********************************************************************************/
        	...
        	this.fn_aggregate  = function() {
        		...
        		var sSvcID      	= "tranAggregate";  
        		var sController   	= "ntrms/re/tranAggregate.do";
        		var sInDatasets   	= "";
        		var sOutDatasets  	= "";
        		var sArgs 			= "";	
        		var fn_callBack		= "fn_callBack";
        		
        		sArgs += Ex.util.setParam("rqstDay"	, rqstDay);		//출금이체청구일
        	...
        	{ 
        		...
        		switch (strSvcId) 
        		{
        			...
        			case "getCommCode":
        				...
        				for(var i=0; i<this.ds_R005.rowcount; i++) {
        					this.ds_list.addRow();
        					this.ds_list.setColumn(i,"payDd"		, this.ds_R005.getColumn(i,"cd"));
        	...
        	***********************************************************************************/
        	...
        	this.fn_valid = function () {
        		...
        		{
        			alert('출금이체청구일은 영업일기준 익일과 당일만 가능합니다.');
        			this.div_search.cal_accReqDate.set_value("");			
        			this.div_search.cal_accReqDate.setFocus();
        			return false;
        		}		
        ...
        this.loadIncludeScript("RTREAccTranProc_tab1.xfdl");
