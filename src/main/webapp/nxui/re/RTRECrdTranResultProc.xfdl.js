    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRECrdTranResultProc");
                this.set_classname("re00050_cms");
                this.set_titletext("카드이체 결과처리");
            ...
            obj.set_url("re::RTRECrdTranResultProc_tab1.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab02);
            obj.set_text("[STEP 2] 결과파일반영조회");
            obj.set_url("re::RTRECrdTranResultProc_tab2.xfdl");
            this.Tab02.addChild(obj.name, obj);
            obj = new Tabpage("tabpage3", this.Tab02);
            obj.set_text("[STEP 3] 카드이체수납처리");
            obj.set_url("re::RTRECrdTranResultProc_tab3.xfdl");
            this.Tab02.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "re::RTRECrdTranResultProc_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTRECrdTranResultProc_tab2.xfdl");
            this._addPreloadList("fdl", "re::RTRECrdTranResultProc_tab3.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTRECrdTranResultProc.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRECrdTranResultProc.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 수금관리 > 카드이체관리 > 카드이체 결과처리
         * 02. 그룹명   : RTRECrdTranResultProc.xfdl
         * 03. 그룹설명 : 
         * 04. 작성일   :
         * 05. 작성자   :
         * 06. 수정이력 :
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTRECrdTranResultProc.xfdl");
