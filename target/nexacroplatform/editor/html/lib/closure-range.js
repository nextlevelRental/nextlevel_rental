  ...
  if (s == 'object') {
    if (value) {
      ...
      if ((className == '[object Array]' ||
           ...
           isTypeOfUndefined(value.splice) != undefined+'' &&
 ...
 *     system.
 */
goog.userAgent.ASSUMEwindowDOWS = false;
...
goog.userAgent.PLATFORM_KNOWN_ =
    ...
    goog.userAgent.ASSUMEwindowDOWS ||
...
goog.userAgent.WINDOWS = goog.userAgent.PLATFORM_KNOWN_ ?
    goog.userAgent.ASSUMEwindowDOWS : goog.userAgent.detectedWindows_;
 ...
 *
 * @param {Window=} optwindowdow Optional window element to test.
 * @return {!goog.math.Size} Object with values 'width' and 'height'.
 */
goog.dom.getViewportSize = function(optwindowdow) {
  // TODO(user): This should not take an argument
  return goog.dom.getViewportSize_(optwindowdow || window);
};
 ...
 *
 * @param {Document=} optdocument  Document object to get window for.
 * @return {Window} The window associated with the given document.
 */
goog.dom.getWindow = function(optdocument) {
  // TODO(user): This should not take an argument.
  return optdocument ? goog.dom.getWindow_(optdocument) : window;
};
 ...
 * @param {Document=} optdocumentument Document object to associate with this
 *     DOM helper.
 * @constructor
 */
goog.dom.DomHelper = function(optdocumentument) {
  /**
   * Reference to the document object to use
   * @type {!Document}
   * @private
   */
  this.document_ = optdocumentument || goog.global.document || document;
};
...
/**
 * Gets the dimensions of the viewport.
 * @param {Window=} optwindowdow Optional window element to test. Defaults to
 *     the window of the Dom Helper.
 * @return {!goog.math.Size} Object with values 'width' and 'height'.
 */
goog.dom.DomHelper.prototype.getViewportSize = function(optwindowdow) {
  // TODO(user): This should not take an argument. That breaks the rule of a
  // a DomHelper representing a single frame/window/document.
  return goog.dom.getViewportSize(optwindowdow || this.getWindow());
};
 ...
 * @param {Window=} optwindow The window to get the selection of.  Defaults to the
 *     window this class was defined in.
 * @return {goog.dom.AbstractRange?} A range wrapper object, or null if there
 *     was an error.
 */
goog.dom.Range.createFromWindow = function(optwindow) {
 ...
 *     window this class was defined in.
 */
goog.dom.Range.clearSelection = function(optwindow) {
  var sel = goog.dom.AbstractRange.getBrowserSelectionForWindow(
      optwindow || window);
  if (!sel) {
    return;
