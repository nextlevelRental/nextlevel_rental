    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTSDContractStatus_tab_info10_prdInfo");
                this.set_classname("RTSDContractStatus_tab_info5_preminumService");
                this.set_titletext("[STEP10]제품정보");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"123\"/><Column size=\"251\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"110\"/><Column size=\"148\"/><Column size=\"153\"/><Column size=\"60\"/><Column size=\"53\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"상품코드\" expandsize=\"13\"/><Cell col=\"1\" text=\"상품명\"/><Cell col=\"2\" text=\"렌탈기간\"/><Cell col=\"3\" text=\"계절구분\"/><Cell col=\"4\" text=\"본수\"/><Cell col=\"5\" text=\"장착예정일\"/><Cell col=\"6\" text=\"장착일\"/><Cell col=\"7\" text=\"거점재고\"/><Cell col=\"8\" text=\"재고유형\"/></Band><Band id=\"body\"><Cell celltype=\"none\" displaytype=\"normal\" edittype=\"readonly\" text=\"bind:matCd\"/><Cell col=\"1\" celltype=\"none\" edittype=\"readonly\" text=\"bind:matNm\"/><Cell col=\"2\" celltype=\"none\" edittype=\"readonly\" text=\"bind:periodNm\"/><Cell col=\"3\" celltype=\"none\" edittype=\"readonly\" text=\"bind:seasonNm\"/><Cell col=\"4\" celltype=\"none\" displaytype=\"normal\" edittype=\"readonly\" text=\"bind:cntNm\"/><Cell col=\"5\" displaytype=\"normal\" edittype=\"readonly\" text=\"bind:planDay\" mask=\"####-##-##\" calendardisplaynulltype=\"none\"/><Cell col=\"6\" displaytype=\"normal\" edittype=\"readonly\" text=\"bind:instDay\" mask=\"####-##-##\" calendardisplay=\"edit\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" text=\"bind:o2oStockYn\"/><Cell col=\"8\" text=\"bind:outStockTypeNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDContractStatus_tab_info10_prdInfo.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDContractStatus_tab_info10_prdInfo.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        //include "lib::comLib.xjs";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.obj_data;
        this.BUTTON_CELL = 0;			//버튼CELL 위치
        ...
        {
            this.addEventHandler("onload", this.RTSDContractStatus_tab_info10_prdInfo_onload, this);

        };

        this.loadIncludeScript("RTSDContractStatus_tab_info10_prdInfo.xfdl");
