...
@Repository("rTSDClaimMapDAO")

public class RTSDClaimMapDAO extends EgovAbstractDAO {
	...
	public List<Map> getClaimRegList(Map map, Map <String, DataSetMap> outDataset) throws NtRmsDaoException {
		getSqlMapClientTemplate().queryForObject("claim.listClaim", map);
