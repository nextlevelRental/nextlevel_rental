...
@Repository("rTSDAnalyzePDFMapDAO")

public class RTSDAnalyzePDFMapDAO extends RtcmAbstractDAO {
	...
	public List<Map> listAnalyzePDF(Map map, Map <String, DataSetMap> outDataset) throws NtRmsDaoException {
		getSqlMapClientTemplate().queryForObject("analyzePDF.sAnalyzePDFList", map);
