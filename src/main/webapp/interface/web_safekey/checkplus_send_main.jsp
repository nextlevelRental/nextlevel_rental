...
<%
  ...
  request.setCharacterEncoding("euc-kr");
	...
	*/
	...
	/*
		...
		예) '남자' 인 경우
		    gender = "1";
	*/
	String gender = request.getParameter("gender") == null ? "" : (String)request.getParameter("gender") ;
	...
	String birthGen = birthdate + "-" + gender;
	System.out.println(birthGen);
	/*
	...
	*/
	...
	System.out.println("[" + URLEncoder.encode(request.getParameter("username"), "euc-kr") + "] 이름");
	...
	*/
	String sSendResultUrl = "https://portal.tirerental.co.kr/interface/web_safekey/checkplus_send_result.jsp";
	...
	*/
	/* 
		[20220622] kstka Edge or Chrome상위버전의 경우 URL이 다른 경우 통신시 post방식으로 param_r1, param_r2, param_r3를 따로 넘기는 경우 session id를 재생성해 기존 세션이 끊어지는 현상 발생
		Get방식으로 변경 - NICE담당자 가이드
	*/
	String sReturnUrl 	= "https://portal.tirerental.co.kr/interface/web_safekey/checkplus_success.jsp?param_r1=" + username + "&param_r2=" + mobileno + "&param_r3=" + birthGen;      // 성공시 이동될 URL
	String sErrorUrl   	= "https://portal.tirerental.co.kr/interface/web_safekey/checkplus_fail.jsp?param_r1=" + username + "&param_r2=" + mobileno + "&param_r3=" + birthGen;         // 실패시 이동될 URL
...
<!-- [20220622] kstka 세션이 끊어지는 현상 보완을 위해 post방식으로 넘기는 파라미터를 get방식으로 전환 -->
