...
<head>
	...
	<script language='javascript'>
		function fnLoad()
		{
			...
			opener.document.vnoform.action = "ipin_result.jsp";
			opener.document.vnoform.submit();
			
			//self.close();
			 --%>
			document.ipin_form.enc_data.value = "<%= sResponseData %>";
			document.ipin_form.param_r1.value = "<%= sReservedParam1 %>";
			document.ipin_form.param_r2.value = "<%= sReservedParam2 %>";
			document.ipin_form.param_r3.value = "<%= sReservedParam3 %>";
			document.ipin_form.action = "ipin_result.jsp";
			document.ipin_form.submit();
