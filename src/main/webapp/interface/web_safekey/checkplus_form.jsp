...
<%		
	...
	String mobileno 	= request.getParameter("mobileno")		== null ? "" : request.getParameter("mobileno");		//핸드폰번호
	...
	String username 	= request.getParameter("username") 	== null ? "" : request.getParameter("username");		//이름		
...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
	...
	<script type="text/javascript">
		...
		function fn_move_main(sendgubun){	
			...
			frm.action = "http://localhost/interface/web_safekey/checkplus_send_main.jsp";
