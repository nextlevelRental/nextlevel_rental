    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREAccTranProc_tab3");
        ...
        // User Script
        this.addIncludeScript("RTREAccTranProc_tab3.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAccTranProc_tab3.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTREAccTranProc_tab3.xfdl");
