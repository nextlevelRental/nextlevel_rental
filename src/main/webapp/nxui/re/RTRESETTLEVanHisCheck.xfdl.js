    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRESETTLEVanHisCheck");
                this.set_classname("RTREKCPPayHisCheck");
                this.set_titletext("세틀뱅크결제내역체크(가상계좌)");
            ...
            obj.set_url("re::RTRESETTLEVanHisCheck_tab1.xfdl");
            this.Tab00.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab00);
            obj.set_text("[STEP 2] 차이 내역 조회");
            obj.set_url("re::RTRESETTLEVanHisCheck_tab2.xfdl");
            this.Tab00.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1147, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("세틀뱅크결제내역체크(가상계좌)");
        ...
        {
            this._addPreloadList("fdl", "re::RTRESETTLEVanHisCheck_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTRESETTLEVanHisCheck_tab2.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTRESETTLEVanHisCheck.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRESETTLEVanHisCheck.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        //include "lib::comLib.xjs";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.p_arg = "RTRESETTLEVanHisCheck";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.fn_callBack = function (strSvcId,nErrorCode,strErrorMsg){
        	
        }
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.RTRESETTLEVanHisCheck_onload = function(obj,e){
        	Ex.core.init(obj);
        }
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        this.loadIncludeScript("RTRESETTLEVanHisCheck.xfdl");
