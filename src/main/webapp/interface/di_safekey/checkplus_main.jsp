...
<%
    ...
    //sRequestNumber = niceCheck.getRequestNO(sRequestNumber);
    ...
    String sReturnUrl = "http://portal.tirerental.co.kr/checkplus_success.jsp";      // 성공시 이동될 URL
    String sErrorUrl = "http://portal.tirerental.co.kr/checkplus_fail.jsp";          // 실패시 이동될 URL
