    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRESETTLEVanHisCheck_tab1");
            ...
            obj = new FileUpload("settleVanUploadFile", "absolute", "160", "160", "491", "50", null, null, this);
            obj.set_taborder("22");
            ...
            obj = new Button("bt_settleVanAdd", "absolute", "671", "160", "58", "22", null, null, this);
            obj.set_taborder("23");
            obj.set_text("파일추가");
            obj.set_cssclass("btn_WF_module");
            this.addChild(obj.name, obj);

            obj = new Button("bt_settleVanDelete", "absolute", "671", "184", "58", "22", null, null, this);
            obj.set_taborder("24");
            obj.set_text("파일삭제");
            obj.set_cssclass("btn_WF_module");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTRESETTLEVanHisCheck_tab1.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRESETTLEVanHisCheck_tab1.xfdl", function() {
        ...
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/	
        this.RTRESETTLEVanHisCheck_tab1_onload = function(obj,e){
        	Ex.core.init(obj); 	
        	this.fn_init();
        }
        ...
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.FN_settleVanUploadFile = function(obj,e){
        	var checkDay = nvl(this.div_search.cal_checkDay.value);
        	var checkSet = nvl(this.div_search.cb_checkSet.value);
        ...
        this.settleVanUploadFile_onerror = function(obj,e){
        ...
        this.settleVanUploadFile_onsuccess = function(obj,e){
        	application.set_httptimeout(60);
        	Ex.core.set_wait(false);
        	alert(e.errormsg);
        	this.reload();
        ...
        this.bt_settleVanAdd_onclick = function(obj,e){
        ...
        this.bt_settleVanDelete_onclick = function(obj,e){
        	var fileCnt	 = this.settleVanUploadFile.getItemCount(false);
        	if( fileCnt == 2){
        ...
        {
            this.addEventHandler("onload", this.RTRESETTLEVanHisCheck_tab1_onload, this);
            ...
            this.settleVanUploadFile.addEventHandler("onerror", this.settleVanUploadFile_onerror, this);
            this.settleVanUploadFile.addEventHandler("onsuccess", this.settleVanUploadFile_onsuccess, this);
            this.bt_settleVanAdd.addEventHandler("onclick", this.bt_settleVanAdd_onclick, this);
            this.bt_settleVanDelete.addEventHandler("onclick", this.bt_settleVanDelete_onclick, this);

        };

        this.loadIncludeScript("RTRESETTLEVanHisCheck_tab1.xfdl");
