(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"chk\" type=\"STRING\" size=\"256\"/><Column id=\"rntMstId\" type=\"STRING\" size=\"0\"/><Column id=\"rntOfc\" type=\"STRING\" size=\"0\"/><Column id=\"rntPnt\" type=\"STRING\" size=\"0\"/><Column id=\"rntOfcNm\" type=\"STRING\" size=\"256\"/><Column id=\"rntPntNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"chk\" type=\"STRING\" size=\"256\"/><Column id=\"rntMstId\" type=\"STRING\" size=\"0\"/><Column id=\"rntOfc\" type=\"STRING\" size=\"0\"/><Column id=\"rntPnt\" type=\"STRING\" size=\"0\"/><Column id=\"rntOfcNm\" type=\"STRING\" size=\"256\"/><Column id=\"rntPntNm\" type=\"STRING\" size=\"256\"/><Column id=\"delChk\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("25");
            obj.set_text("렌탈 지사/지점");
            obj.set_cssclass("sta_WF_schTitle");
            obj.getSetter("domainId").set("nexa.s_condition");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_rentalNm", "absolute", "687", "10", "124", "21", null, null, this.div_search);
            obj.set_taborder("26");
            obj.set_maxlength("100");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_autofittype("col");
            obj.set_nodatatext("조회된 데이터가 없습니다.");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"39\"/><Column size=\"221\"/><Column size=\"267\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"선택\"/><Cell col=\"1\" text=\"렌탈지사명\"/><Cell col=\"2\" text=\"렌탈지점명\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:chk\"/><Cell col=\"1\" edittype=\"none\" text=\"bind:rntOfcNm\" editlimit=\"4\"/><Cell col=\"2\" edittype=\"none\" text=\"bind:rntPntNm\" editlimit=\"100\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDRentalMasterAuth.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDRentalMasterAuth.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 렌탈마스터 권한설정
         * 02. 그룹명   : 공통관리-렌탈관리
         * 03. 그룹설명 :
        ...
        ***********************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.edt_rentalNm.addEventHandler("onkeyup", this.div_search_edt_grpNm_onkeyup, this);

        };

        this.loadIncludeScript("RTSDRentalMasterAuth.xfdl");
