    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("File upload and download(RUNTIME)");
                this._setFormPosition(0,0,1024,582);
            }
            ...
            obj = new Static("st_bg", "absolute", "42", "165", "480", "267", null, null, this);
            obj.set_taborder("2");
            obj.style.set_background("#fdf0ffff");
            obj.style.set_border("1 solid #d1afd6ff");
            obj.style.set_bordertype("round 5 5");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_files", "absolute", "52", "214", "460", "202", null, null, this);
            obj.set_taborder("20");
            ...
            obj = new Static("st_helpMessage", "absolute", "54", "216", "455", "198", null, null, this);
            obj.set_taborder("32");
            obj.set_text("마우스로 파일을 끌어오세요.");
            obj.style.set_background("white");
            obj.style.set_border("0 solid #d1afd6ff");
            obj.style.set_bordertype("round 5 5");
            ...
            obj = new Static("st_title00", "absolute", "42", "56", "454", "38", null, null, this);
            obj.set_taborder("19");
            obj.set_text("File Upload");
            obj.style.set_font("bold antialias 18 Verdana");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("img_loading", "absolute", "191", "294", "200", "60", null, null, this);
            obj.set_taborder("22");
            ...
            obj = new Static("st_downloadTitle", "absolute", "552", "166", "457", "38", null, null, this);
            obj.set_taborder("23");
            ...
            obj = new Static("st_downloadBg", "absolute", "552", "203", "460", "221", null, null, this);
            obj.set_taborder("24");
            obj.style.set_background("#fdf0ffff");
            obj.style.set_border("1 solid #d1afd6ff");
            obj.style.set_bordertype("round 5 5");
            ...
            obj = new Grid("grd_download", "absolute", "560", "214", "444", "200", null, null, this);
            obj.set_taborder("25");
            ...
            obj = new Button("btn_selectFiles", "absolute", "194", "178", "118", "30", null, null, this);
            obj.set_taborder("26");
            obj.set_text("Add Files...");
            obj.style.set_background("#8a4296ff URL('image::fileUpDownload/file_btn_AddFiles.png') 13 48");
            ...
            obj = new Button("btn_clearAll", "absolute", "318", "178", "110", "30", null, null, this);
            obj.set_taborder("27");
            obj.set_text("Delete All");
            obj.style.set_background("#8a4296ff URL('image::fileUpDownload/file_btn_DeleteAll.png') 13 48");
            obj.style.set_color("white");
            obj.style.set_padding("0 0 0 30");
            obj.style.set_align("left middle");
            ...
            obj = new Button("btn_save", "absolute", "435", "178", "75", "30", null, null, this);
            obj.set_taborder("28");
            obj.set_text("Save");
            obj.style.set_background("#5d5d5dff URL('image::fileUpDownload/file_btn_Save.png') 15 48");
            obj.style.set_color("white");
            obj.style.set_padding("0 0 0 30");
            obj.style.set_align("left middle");
            obj.style.set_font("bold antialias 10 Verdana");
            ...
            obj = new Static("st_support_dnd", "absolute", "60", "92", "460", "20", null, null, this);
            obj.set_taborder("29");
            obj.set_text("• Drag and Drop 지원");
            obj.style.set_align("left bottom");
            obj.style.set_font("antialias 12 Verdana");
            this.addChild(obj.name, obj);

            obj = new Static("st_support_progressBar", "absolute", "60", "113", "460", "20", null, null, this);
            obj.set_taborder("30");
            obj.set_text("• ProgressBar 지원");
            obj.style.set_align("left bottom");
            obj.style.set_font("antialias 12 Verdana");
            this.addChild(obj.name, obj);

            obj = new Static("st_support_multiple", "absolute", "60", "136", "460", "20", null, null, this);
            obj.set_taborder("31");
            obj.set_text("• File 다중선택 지원");
            obj.style.set_align("left bottom");
            obj.style.set_font("antialias 12 Verdana");
            this.addChild(obj.name, obj);

            obj = new ExtFileUpload("extUpload", "absolute", "636", "16", "100", "100", null, null, this);
            obj.style.set_border("1 solid #808080ff");
            this.addChild(obj.name, obj);

            obj = new ExtFileDownload("extDownload", "absolute", "784", "16", "100", "100", null, null, this);
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 1024, 582, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("FileUpDownload");
            		p.set_titletext("File upload and download(RUNTIME)");
        ...
        // User Script
        this.registerScript("FileUpDownload_UI.xfdl", function() {
        ...
        this.fileConfig = {
        		host : "http://172.10.10.54:7001/nexacro/",
        		uploadUrl : "file/saveFile.jsp?path=nexacro/repository",
        ...
        this.downloadFile = function(row)
        {
        	 ...
        	 */ 	
        	this.extDown.download(downloadUrl + fileName, fileName);		
        }
        ...
        */
        ...
        this.loadIncludeScript("FileUpDownload_UI.xfdl");
