(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_ok", "absolute", "162", "121", "45", "20", null, null, this);
            obj.set_taborder("0");
            obj.set_text("확인");
            ...
            obj.set_taborder("1");
            obj.style.set_background("transparent URL('image::alert_default.png')");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("alertPopup.xfdl", "lib::lib_common.xjs");
        this.registerScript("alertPopup.xfdl", function() {
        ...
        //	trace("pMessage ==>"+this.parent.pMessage);
        ...
        this.loadIncludeScript("alertPopup.xfdl");
