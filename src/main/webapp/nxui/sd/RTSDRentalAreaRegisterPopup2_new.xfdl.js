    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTSDRentalAreaRegisterPopup2_new");
                this.set_classname("Authority");
                this.set_titletext("렌탈지역등록팝업2");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"209\"/><Column size=\"256\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"렌탈지사\"/><Cell col=\"2\" text=\"렌탈지역\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:chk\"/><Cell col=\"1\" edittype=\"none\" style=\"align:center;\" text=\"bind:rentalGroupNm\"/><Cell col=\"2\" text=\"bind:cdNm\" editlimit=\"100\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RTSDRentalAreaRegisterPopup2_new.xfdl", "lib::comLib.xjs");
        this.registerScript("RTSDRentalAreaRegisterPopup2_new.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 렌탈지역등록 팝업
         * 02. 그룹명   : 기준정보
         * 03. 그룹설명 :
        ...
        ***********************************************************************************/
        	...
        	this.fn_search = function() {
        		...
        		var sArgs		 = "";
        			sArgs		+= Ex.util.setParam("usrGroup",	nvl(application.gds_userInfo.getColumn(0, "userGrp")));
        			sArgs		+= Ex.util.setParam("usrId",	nvl(application.gds_userInfo.getColumn(0, "userId")));
        			sArgs		+= Ex.util.setParam("keyword",	nvl(this.div_search.edt_prodNm.value));
        	...
        	switch(strSvcId) {
        		case "listRentalOffice":
        			for(var i = 0; i < this.dsList.rowcount; i++) {
        				...
        				this.dsList.setColumn(i, "rentalOffice",   this.dsList.getColumn(i, "cd"));
        				this.dsList.setColumn(i, "rentalOfficeNm", this.dsList.getColumn(i, "cdNm"));
        			}
        			break;
        		default:
        			break;
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("RTSDRentalAreaRegisterPopup2_new.xfdl");
