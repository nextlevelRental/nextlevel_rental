    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTREAcquisition");
                this.set_classname("test_form");
                this.set_titletext("자산별 매출원가 취득처리");
        ...
        // User Script
        this.addIncludeScript("RTREAcquisition.xfdl", "lib::comLib.xjs");
        this.registerScript("RTREAcquisition.xfdl", function() {
        /***********************************************************************
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("RTREAcquisition.xfdl");
