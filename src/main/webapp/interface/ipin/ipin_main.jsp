...
<%
	...
	*********************************************************************************************************************************************/
	...
	String sSiteCode				= "L743";			// IPIN 서비스 사이트 코드		(NICE평가정보에서 발급한 사이트코드)
	...
	└────────────────────────────────────────────────────────────────────
	*/
	String sReturnURL				= "http://localhost:8080/ipin_process.jsp";
...
<form name="form_ipin" method="post">
    ...
    <a href="javascript:fnPopup();"><img src="http://image.creditbank.co.kr/static/img/vno/new_img/bt_17.gif"  id="fn_popup" width=218 height=40 border=0></a>
</form>
