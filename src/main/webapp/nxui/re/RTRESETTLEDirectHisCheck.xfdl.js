    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("RTRESETTLEDirectHisCheck");
                this.set_classname("RTREKCPPayHisCheck");
                this.set_titletext("세틀뱅크결제내역체크(즉시출금)");
            ...
            obj.set_url("re::RTRESETTLEDirectHisCheck_tab1.xfdl");
            this.Tab00.addChild(obj.name, obj);
            obj = new Tabpage("tabpage2", this.Tab00);
            obj.set_text("[STEP 2] 차이 내역 조회");
            obj.set_url("re::RTRESETTLEDirectHisCheck_tab2.xfdl");
            this.Tab00.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1147, 496, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("세틀뱅크결제내역체크(즉시출금)");
        ...
        {
            this._addPreloadList("fdl", "re::RTRESETTLEDirectHisCheck_tab1.xfdl");
            this._addPreloadList("fdl", "re::RTRESETTLEDirectHisCheck_tab2.xfdl");
        };
        
        // User Script
        this.addIncludeScript("RTRESETTLEDirectHisCheck.xfdl", "lib::comLib.xjs");
        this.registerScript("RTRESETTLEDirectHisCheck.xfdl", function() {
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        //include "lib::comLib.xjs";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.p_arg = "RTRESETTLEDirectHisCheck";
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.fn_callBack = function (strSvcId,nErrorCode,strErrorMsg){
        	
        }
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        this.RTRESETTLEDirectHisCheck_onload = function(obj,e){
        	Ex.core.init(obj);
        }
        /*|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||*/
        ...
        {
            this.addEventHandler("onload", this.RTRESETTLEDirectHisCheck_onload, this);
            this.Tab00.addEventHandler("onchanged", this.Tab00_onchanged, this);

        };

        this.loadIncludeScript("RTRESETTLEDirectHisCheck.xfdl");
